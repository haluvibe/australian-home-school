...
export default function FoundationEnglishWorksheetLanding() {
  const grouped = foundationEnglishWorksheets.reduce<Record<string, typeof foundationEnglishWorksheets>>(
    (acc, ws) => {
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-10 pt-14 sm:px-6 sm:pb-14 sm:pt-28 lg:px-8 lg:pb-16 lg:pt-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-charcoal-light sm:mt-6 sm:text-lg">
              Colourful, curriculum-aligned worksheets for Foundation Year. Just click, print and learn!
            </p>
          </div>
        </div>
      </section>
              ...
              <div key={strand}>
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  {worksheets.map((ws) => (
                    <Link
                      key={ws.slug}
                      href={`/worksheets/english/foundation/${ws.slug}`}
