...
export const metadata: Metadata = {
  title: "Year 7 English Worksheets",
  description:
    "Free printable Year 7 English worksheets aligned to the Australian Curriculum V9. Covering phonics, reading, writing, grammar and literature.",
  keywords: ["Year 7 english worksheets", "Year 7 english Australia", "homeschool Year 7 english", "Australian Curriculum Year 7"],
  alternates: { canonical: "/worksheets/english/year-7" },
  openGraph: {
    title: "Year 7 English Worksheets | Australian Home Schooling",
    description: "Free printable Year 7 English worksheets covering phonics, reading, writing, grammar and literature.",
    url: "/worksheets/english/year-7",
  },
};
...
export default function Year7EnglishWorksheetLanding() {
  const grouped = year7EnglishWorksheets.reduce<Record<string, typeof year7EnglishWorksheets>>(
    (acc, ws) => {
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-10 pt-14 sm:px-6 sm:pb-14 sm:pt-28 lg:px-8 lg:pb-16 lg:pt-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-charcoal-light sm:mt-6 sm:text-lg">
              Thoughtfully designed worksheets for Year 7 English. Each includes a full lesson guide, analytical activities and curated online resources.
            </p>
          </div>
        </div>
      </section>
              ...
              <div key={strand}>
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  {worksheets.map((ws) => (
                    <Link
                      key={ws.slug}
                      href={`/worksheets/english/year-7/${ws.slug}`}
