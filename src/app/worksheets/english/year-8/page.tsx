...
export const metadata: Metadata = {
  title: "Year 8 English Worksheets",
  description:
    "Free printable Year 8 English worksheets aligned to the Australian Curriculum V9. Covering phonics, reading, writing, grammar and literature.",
  keywords: ["Year 8 english worksheets", "Year 8 english Australia", "homeschool Year 8 english", "Australian Curriculum Year 8"],
  alternates: { canonical: "/worksheets/english/year-8" },
  openGraph: {
    title: "Year 8 English Worksheets | Australian Home Schooling",
    description: "Free printable Year 8 English worksheets covering phonics, reading, writing, grammar and literature.",
    url: "/worksheets/english/year-8",
  },
};
...
export default function Year8EnglishWorksheetLanding() {
  const grouped = year8EnglishWorksheets.reduce<Record<string, typeof year8EnglishWorksheets>>(
    (acc, ws) => {
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-10 pt-14 sm:px-6 sm:pb-14 sm:pt-28 lg:px-8 lg:pb-16 lg:pt-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-charcoal-light sm:mt-6 sm:text-lg">
              Curriculum-aligned Year 8 English worksheets covering textual analysis, literature, analytical essay writing, and research skills. Designed for independent thinkers.
            </p>
          </div>
        </div>
      </section>
              ...
              <div key={strand}>
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  {worksheets.map((ws) => (
                    <Link
                      key={ws.slug}
                      href={`/worksheets/mathematics/year-8/${ws.slug}`}
