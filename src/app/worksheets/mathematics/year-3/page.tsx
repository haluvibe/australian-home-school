...
export const metadata: Metadata = {
  ...
  description:
    "Free printable Year 3 Mathematics worksheets aligned to the Australian Curriculum. Covering number, algebra, measurement, space, statistics and probability.",
};
