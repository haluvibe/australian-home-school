...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Year 10 Mathematics Worksheets | AI Native School",
...
const strandColors: Record<string, string> = {
  ...
  Probability: "bg-eucalyptus/10 text-eucalyptus-dark border-eucalyptus/20",
};
...
export default function Year10WorksheetLanding() {
  const grouped = year10MathsWorksheets.reduce<Record<string, typeof year10MathsWorksheets>>(
    (acc, ws) => {
        ...
        <div className="relative mx-auto max-w-7xl px-5 pb-10 pt-14 sm:px-6 sm:pb-14 sm:pt-28 lg:px-8 lg:pb-16 lg:pt-32">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-xl text-base leading-relaxed text-charcoal-light sm:mt-6 sm:text-lg">
              Colourful, curriculum-aligned worksheets for Year 10
              ...
              <div key={strand}>
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  {worksheets.map((ws) => (
                    <Link
                      key={ws.slug}
                      href={`/worksheets/mathematics/year-10/${ws.slug}`}
