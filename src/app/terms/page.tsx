...
export const metadata: Metadata = {
  title: "Terms of Service — Australian Home School",
  description:
    "Terms of service for Australian Home School. Read our terms and conditions for using our website and services.",
};
          ...
          <div className="prose-custom space-y-10">
            <div>
              ...
              <p className="mt-3 text-base leading-relaxed text-charcoal-light/85">
                By accessing or using the Australian Home School website
            ...
            <div>
              ...
              <p className="mt-3 text-base leading-relaxed text-charcoal-light/85">
                Australian Home School provides educational information,
            ...
            <div>
              ...
              <p className="mt-3 text-base leading-relaxed text-charcoal-light/85">
                ...
                are owned by Australian Home School and are protected by
            ...
            <div>
              ...
              <p className="mt-3 text-base leading-relaxed text-charcoal-light/85">
                You agree to indemnify and hold harmless Australian Home School
