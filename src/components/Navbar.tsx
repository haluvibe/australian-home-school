...
const dropdowns: Record<string, DropdownConfig> = {
  "Guides & Tools": {
    tagline: "Resources to help\nyou teach with confidence",
    items: [
      {
        label: "Maths Progression Map",
        href: "/curriculum/progression",
        icon: (
      ...
      {
        label: "Manipulatives Guide",
        href: "/guides/manipulatives",
        icon: (
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        {/* CTA + GitHub + Mobile toggle */}
        <div className="flex items-center gap-3">
          <a
            href="https://github.com/haluvibe/australian-home-school"
            target="_blank"
            rel="noopener noreferrer"
            className="hidden h-10 w-10 items-center justify-center rounded-lg text-charcoal-light transition-colors hover:text-charcoal lg:flex"
        ...
        <div className="space-y-1 px-6 py-4">
          ...
          <div className="flex flex-col gap-3 pt-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 rounded-full border border-charcoal/10 px-5 py-3 text-sm font-medium text-charcoal-light transition-colors hover:text-charcoal"
              onClick={() => setMobileOpen(false)}
            >
