...
export const year10MathsWorksheets: WorksheetItem[] = [
    ...
    activities: [
      ...
      },
      {
        ...
        questions: [
          ...
          { prompt: "A magnitude 8 earthquake is twice as strong as magnitude 4", options: ["FALSE", "TRUE"] },
      ...
      },
      {
        ...
        categories: [
          { label: "Wrong power of 10 selected", icon: "star", count: 8 },
      ...
      {
        type: "sorting",
        title: "Logarithm Laws — Identify the Law Used",
        instruction: "Sort each equation into the logarithm law it demonstrates.",
        columns: ["Product law", "Quotient law", "Power law"],
        items: [
          { label: "log(6) = log(2) + log(3)" },
          { label: "log(x⁵) = 5 log(x)" },
          { label: "log(8/2) = log(8) − log(2)" },
          { label: "log(100) = 2 log(10)" },
          { label: "ln(ab) = ln(a) + ln(b)" },
          { label: "log₂(32/4) = log₂(32) − log₂(4)" },
        ],
      },
      {
        type: "open-response",
        title: "Solving Logarithmic Equations",
        instruction: "Solve equations involving logarithms by applying log laws.",
        prompts: [
          { text: "Solve: log₂(x) = 5. Show your steps and verify your answer.", type: "lines", lines: 3 },
          { text: "Solve: log(x) + log(x−3) = 1. Explain any restrictions on x.", type: "lines", lines: 5 },
          { text: "Solve: 3^x = 20 by taking logarithms of both sides. Give your answer to 3 decimal places.", type: "lines", lines: 4 },
          { text: "Bacteria N = 500 × 3^t. When will the count first exceed 50,000? Show full working.", type: "lines", lines: 5 },
        ],
      },
      {
        type: "open-response",
        title: "Applications of Logarithmic Scales",
        instruction: "Interpret and compare real-world data on logarithmic scales.",
        prompts: [
          { text: "The Richter scale is logarithmic. A magnitude 6.0 earthquake releases 31.6× more energy than magnitude 5.0. How much more energy does magnitude 7.0 release than 5.0?", type: "lines", lines: 4 },
          { text: "Sound is measured in decibels on a log scale. A whisper is 30 dB, conversation 60 dB. How many times more intense is conversation?", type: "lines", lines: 4 },
          { text: "Why are logarithmic scales used for data spanning many orders of magnitude? Give two advantages.", type: "lines", lines: 3 },
        ],
      },
    ],
  ...
  // ── WS 2: Growth & Decay Functions ────────────────────────────
  {
    ...
    activities: [
      ...
      {
        type: "circle-correct",
        title: "Doubling Time Estimates",
        instruction: "Use the rule of 70 (doubling time ≈ 70 ÷ rate%) to answer each question.",
        questions: [
          { prompt: "At 6% annual growth, an investment doubles in approximately:", options: ["12 years", "6 years", "70 years"] },
          { prompt: "At 9% annual growth, doubling takes approximately:", options: ["8 years", "9 years", "70 years"] },
          { prompt: "To double your money in 4 years, you need a rate of approximately:", options: ["18%", "4%", "70%"] },
          { prompt: "At 3% inflation, prices double in approximately:", options: ["23 years", "3 years", "36 years"] },
        ],
      },
      ...
      },
      {
        ...
        questions: [
          { prompt: "Exponential growth means the same amount is added each period", options: ["FALSE", "TRUE"] },
          { prompt: "A decay factor of 0.85 means a 15% decrease each period", options: ["TRUE", "FALSE"] },
          { prompt: "Compound interest always gives more than simple interest for the same rate and time", options: ["FALSE", "TRUE"] },
          { prompt: "An exponential function can have a negative base", options: ["FALSE", "TRUE"] },
        ],
      },
      {
        type: "home-activity",
      ...
      {
        type: "open-response",
        title: "Half-Life and Radioactive Decay",
        instruction: "Apply exponential decay to radioactive substances.",
        prompts: [
          { text: "Iodine-131 has a half-life of 8 days. A sample starts at 200 mg. Write an equation for the amount remaining after t days.", type: "lines", lines: 3 },
          { text: "How much iodine-131 remains after 24 days? After 40 days?", type: "lines", lines: 4 },
          { text: "How long until only 10 mg remains? Solve algebraically using logarithms.", type: "lines", lines: 4 },
          { text: "Carbon-14 has a half-life of 5,730 years. If a fossil has 30% of its original C-14 remaining, estimate its age.", type: "lines", lines: 5 },
        ],
      },
      {
        type: "matching",
        title: "Growth and Decay Vocabulary",
        instruction: "Match each term to its correct definition.",
        left: ["Exponential growth", "Exponential decay", "Half-life", "Growth factor", "Decay factor", "Initial value"],
        right: ["The starting amount before any growth or decay", "Time for a quantity to reduce to half its value", "Quantity multiplying by a factor > 1 each period", "The multiplier r where r < 1 in decay", "Quantity multiplying by a factor between 0 and 1", "The multiplier r where r > 1 in growth"],
      },
      {
        type: "circle-correct",
        title: "Identify Growth or Decay",
        instruction: "Circle whether each equation represents growth or decay.",
        questions: [
          { prompt: "P = 500 × (1.08)^t", options: ["Growth", "Decay", "Neither"] },
          { prompt: "A = 1000 × (0.95)^t", options: ["Decay", "Growth", "Neither"] },
          { prompt: "N = 200 × (1.005)^t", options: ["Growth", "Decay", "Neither"] },
          { prompt: "V = 50,000 × (0.85)^t", options: ["Decay", "Growth", "Neither"] },
        ],
      },
      {
        type: "open-response",
        title: "Compound Interest vs Simple Interest",
        instruction: "Compare simple and compound interest and understand the difference.",
        prompts: [
          { text: "Calculate the simple interest on $5,000 at 6% p.a. for 4 years. Write the formula used.", type: "lines", lines: 3 },
          { text: "Calculate the compound interest on $5,000 at 6% p.a. compounded annually for 4 years. Show full working.", type: "lines", lines: 4 },
          { text: "How much more does compound interest earn than simple interest over 4 years? Explain why the difference grows over time.", type: "lines", lines: 3 },
        ],
      },
      {
        type: "circle-correct",
        title: "Compound Interest Formula — Identify Components",
        instruction: "Circle the correct answer about the compound interest formula A = P(1 + r)^n.",
        questions: [
          { prompt: "What does P represent?", options: ["Principal (starting amount)", "Final amount", "Interest rate"] },
          { prompt: "For weekly compounding at 12% p.a., what is r per period?", options: ["12/52 %", "12 %", "12/4 %"] },
          { prompt: "Monthly compounding over 3 years gives n =", options: ["36", "12", "3"] },
          { prompt: "The term (1 + r)^n is called the", options: ["Growth factor", "Principal", "Interest earned"] },
        ],
      },
      {
        type: "open-response",
        title: "Depreciation and Reducing Balance",
        instruction: "Apply exponential decay to asset depreciation.",
        prompts: [
          { text: "A car is purchased for $35,000 and depreciates at 18% per year. Write the equation for its value V after t years.", type: "lines", lines: 2 },
          { text: "Find the car's value after 3 years and after 7 years.", type: "lines", lines: 4 },
          { text: "After how many years will the car's value first fall below $10,000? Solve using logarithms.", type: "lines", lines: 4 },
          { text: "Compare this to straight-line depreciation at the same annual dollar amount. Which model better reflects reality? Explain.", type: "lines", lines: 3 },
        ],
      },
    ],
  ...
  // ── WS 3: Simultaneous Equations & Linear Inequalities ────────
  {
    ...
    lesson: {
      ...
      parentTip: "Simultaneous equations are a great topic for co-learning — you don't need to remember both methods to support your teenager effectively. In fact, having them teach you one method while you work through the other is an excellent strategy. The key conceptual check is whether they understand that the solution is the point where two lines intersect, and that this is why there is exactly one answer for non-parallel lines. If they can explain why parallel lines give no solution and identical lines give infinitely many solutions, they have genuine understanding rather than just procedural steps. Common misconception: when using the elimination method, students often subtract one equation from the other but make sign errors — especially when subtracting negative terms. Encourage them to add the equations whenever possible by first multiplying one equation to make the coefficients cancel. Another common error is solving for one variable but then substituting back into the wrong equation (one that may already have been manipulated), introducing errors. Always substitute into the simplest original equation. Your child is ready for the worksheet when they can: (1) solve a pair of simultaneous equations using both substitution and elimination, (2) check their solution by verifying it satisfies both original equations, (3) represent linear inequalities on a number line, and (4) solve a simple linear inequality and express the solution set.",
    ...
    activities: [
      ...
      },
      {
        ...
        instruction: "Sort each graph description by the number of solutions the system has.",
        columns: ["Exactly one solution", "No solutions", "Infinitely many solutions"],
        items: [
          { label: "Two lines that cross at one point" },
          { label: "Two parallel lines that never meet" },
          { label: "Two lines that lie on top of each other" },
          { label: "A steep line and a flat line crossing" },
          { label: "Two lines with the same y-intercept but different gradients" },
        ],
      },
      ...
      },
      {
        type: "open-response",
        title: "Break-Even Analysis",
        instruction: "Use simultaneous equations to solve business break-even problems.",
        prompts: [
          { text: "A business has fixed costs of $2,000/month and variable costs of $8 per unit. Revenue is $15 per unit. Write equations for total cost C and total revenue R in terms of units sold x.", type: "lines", lines: 3 },
          { text: "Find the break-even point by solving C = R. How many units must be sold to break even?", type: "lines", lines: 3 },
          { text: "Graph both equations and shade the profit region. Label the break-even point.", type: "box" },
          { text: "If fixed costs rise to $2,500, how does the break-even point change? Calculate the new break-even.", type: "lines", lines: 3 },
        ],
      },
      {
        type: "matching",
        title: "Solving Methods — Match to Best Use",
        instruction: "Match each solving method to the type of simultaneous equations it is best suited to.",
        left: ["Substitution method", "Elimination method", "Graphical method", "Matrix method"],
        right: ["Visualising the solution geometrically", "When one equation is already solved for a variable", "When coefficients can be made equal by multiplying", "Solving many equations at once using technology"],
      },
      {
        type: "open-response",
        title: "Linear Programming",
        instruction: "Formulate and solve a simple linear programming problem.",
        prompts: [
          { text: "A factory makes tables (T) and chairs (C). Each table takes 3 hours and each chair takes 1 hour. Available hours: 12. Write the time constraint as an inequality.", type: "lines", lines: 2 },
          { text: "At least 2 tables and 2 chairs must be made. Write these as inequalities.", type: "lines", lines: 2 },
          { text: "Profit: $50 per table, $20 per chair. Write the objective function P = ....", type: "lines", lines: 2 },
          { text: "Graph the feasible region and test each corner point. State the production plan that maximises profit.", type: "box" },
        ],
      },
      {
        type: "matching",
        title: "Inequalities — Match the Graph Description",
        instruction: "Match each inequality to its graph description on a number line.",
        left: ["x > 3", "x ≤ −1", "−2 < x ≤ 4", "x ≥ 0", "x < 5", "−1 ≤ x < 3"],
        right: ["Open circle at −1, arrow to the left", "Closed circle at 0, arrow to the right", "Closed circle at −1, open circle at 3", "Open circle at 3, arrow to the right", "Open circle at 5, arrow to the left", "Open circle at −2, closed circle at 4"],
      },
      {
        type: "open-response",
        title: "Non-Linear Simultaneous Equations",
        instruction: "Solve systems where one equation is linear and one is quadratic.",
        prompts: [
          { text: "Solve simultaneously: y = x + 2 and y = x². Find all intersection points algebraically.", type: "lines", lines: 6 },
          { text: "Interpret your answer geometrically: how many times does the parabola y = x² cross the line y = x + 2?", type: "lines", lines: 2 },
          { text: "Solve simultaneously: y = 2x − 1 and y = x² − 3. Show all working.", type: "lines", lines: 6 },
          { text: "Can a line and parabola intersect at exactly one point? Explain and give an example.", type: "lines", lines: 3 },
        ],
      },
    ],
  ...
  // ── WS 4: Conjectures with Functions & Relations ──────────────
  {
    ...
    activities: [
      ...
      },
      {
        ...
        instruction: "Sort each discriminant result into the correct column.",
        columns: ["Two distinct real solutions", "One repeated real solution", "No real solutions"],
        items: [
          { label: "Δ = 25" },
          { label: "Δ = 0" },
          { label: "Δ = −16" },
      ...
      },
      {
        ...
        instruction: "Investigate how changing parameters affects exponential graphs.",
        prompts: [
          { text: "Describe how y = 2^x + 3 differs from y = 2^x. What is the y-intercept of each?", type: "lines", lines: 3 },
          { text: "Describe how y = 2^(x−1) differs from y = 2^x. In which direction is it shifted?", type: "lines", lines: 3 },
          { text: "Sketch both y = 2^x and y = −2^x on the same axes. What is the relationship between them?", type: "box" },
          { text: "Write the equation of an exponential function that has been reflected in the x-axis and shifted up by 4 units. State its horizontal asymptote.", type: "lines", lines: 3 },
        ],
      },
      {
        type: "tally-chart",
        title: "Function Types Graphed This Week",
        instruction: "Tally each function type you graphed during this unit.",
        categories: [
          { label: "Linear", icon: "pencil", count: 4 },
          { label: "Quadratic", icon: "triangle", count: 6 },
          { label: "Exponential", icon: "star", count: 5 },
          { label: "Hyperbolic", icon: "circle", count: 3 },
          { label: "Piecewise", icon: "square", count: 2 },
        ],
      },
      {
        type: "open-response",
        title: "Sketching Quadratic Functions",
        instruction: "Sketch parabolas by identifying key features.",
        prompts: [
          { text: "For y = x² − 4x + 3, find the x-intercepts, y-intercept, axis of symmetry, and vertex. Show all working.", type: "lines", lines: 6 },
          { text: "Sketch the parabola and label all key features found above.", type: "box" },
          { text: "Convert y = x² − 4x + 3 to vertex form y = (x−h)² + k. Show the completing-the-square process.", type: "lines", lines: 5 },
        ],
      },
    ],
  ...
  // ── WS 5: Surface Area & Volume of Composites ────────────────
  {
    ...
    activities: [
      ...
      {
        type: "open-response",
        title: "Converting Between Units of Volume",
        instruction: "Practise unit conversions for volume in real contexts.",
        prompts: [
          { text: "How many millilitres are in 1 cm³? How many cm³ are in 1 L? Explain the relationship.", type: "lines", lines: 3 },
          { text: "A swimming pool is 25 m long, 12 m wide, and 1.8 m deep. Find its volume in m³ and in kilolitres.", type: "lines", lines: 4 },
          { text: "Convert 750 mm³ to cm³. Convert 2.4 m³ to mm³.", type: "lines", lines: 3 },
        ],
      },
      {
        type: "circle-correct",
        title: "Surface Area Formula — Select the Right One",
        instruction: "Circle the correct surface area formula for each shape.",
        questions: [
          { prompt: "Total surface area of a cylinder (radius r, height h)", options: ["2πr² + 2πrh", "πr² + 2πrh", "2πrh"] },
          { prompt: "Surface area of a sphere (radius r)", options: ["4πr²", "2πr²", "πr²"] },
          { prompt: "Lateral surface area of a cone (radius r, slant height l)", options: ["πrl", "πr²l", "2πrl"] },
          { prompt: "Total surface area of a cube (side a)", options: ["6a²", "4a²", "a³"] },
        ],
      },
      {
        type: "matching",
        title: "3D Shape Properties — Match the Fact",
        instruction: "Match each 3D shape to one of its key properties.",
        left: ["Sphere", "Cone", "Cylinder", "Rectangular prism", "Triangular pyramid", "Regular tetrahedron"],
        right: ["Has a curved surface and two parallel circular faces", "All four faces are equilateral triangles", "Has 8 vertices, 12 edges, 6 faces", "Has one apex and a circular base", "Has 4 triangular faces and 1 rectangular base", "Every point on the surface is equidistant from the centre"],
      },
      {
        type: "home-activity",
        title: "3D Shapes in Architecture and Engineering",
        instruction: "Explore how 3D geometry is used in design and construction.",
        suggestions: [
          "Research the Sydney Opera House. What 3D shapes make up its iconic roof? Estimate the surface area from publicly available dimensions.",
          "Look at three food packages at home. Identify the 3D shape of each and calculate which uses the least packaging material for a similar volume.",
          "Research how architects use software (like AutoCAD or Revit) to calculate surface areas and volumes. Write a paragraph about one use.",
          "Build a model of a composite solid using clay or paper. Measure its dimensions and calculate the surface area and volume.",
          "Find out why bees build hexagonal honeycombs. Research how the hexagonal prism minimises wax use for a given volume of honey.",
        ],
      },
    ],
  ...
  // ── WS 6: Pythagoras' Theorem & Trigonometry ──────────────────
  {
    ...
    activities: [
      ...
      {
        type: "open-response",
        title: "Applying the Sine and Cosine Rules",
        instruction: "Use the sine and cosine rules in non-right triangles.",
        prompts: [
          { text: "In triangle ABC: a = 12, b = 9, C = 55°. Find c using the cosine rule.", type: "lines", lines: 4 },
          { text: "In triangle PQR: p = 7, Q = 48°, R = 62°. Find q using the sine rule.", type: "lines", lines: 4 },
          { text: "Two sides of a triangle are 8 cm and 11 cm, and the included angle is 130°. Find the third side.", type: "lines", lines: 4 },
          { text: "Explain when the sine rule has two possible solutions (the ambiguous case). Give an example.", type: "lines", lines: 4 },
        ],
      },
      {
        type: "sorting",
        title: "Trigonometry Problem Context",
        instruction: "Sort each trigonometry problem into its real-world context.",
        columns: ["Surveying & navigation", "Architecture & construction", "Physics & engineering"],
        items: [
          { label: "Finding the angle of a roof slope" },
          { label: "Calculating the trajectory of a projectile" },
          { label: "Determining a ship's bearing" },
          { label: "Finding the height of a ramp for accessibility" },
          { label: "Measuring the angle to a hilltop from the plain" },
          { label: "Resolving forces at angles on a bridge" },
        ],
      },
      {
        type: "open-response",
        title: "Pythagorean Proofs",
        instruction: "Explore different proofs of Pythagoras' theorem.",
        prompts: [
          { text: "State Pythagoras' theorem and draw a right triangle with sides labelled a, b, and c.", type: "box" },
          { text: "Describe one proof of Pythagoras' theorem (e.g. using four copies of a right triangle arranged inside a square). Explain the key steps.", type: "lines", lines: 5 },
          { text: "Verify Pythagoras' theorem for the Pythagorean triple (5, 12, 13). Calculate all three sides of a triangle with these proportions and check a² + b² = c².", type: "lines", lines: 4 },
          { text: "Can Pythagoras' theorem be extended to 3D? Write the formula for the space diagonal of a rectangular box.", type: "lines", lines: 3 },
        ],
      },
    ],
  ...
  // ── WS 7: Measurement Errors & Proportion ─────────────────────
  {
    ...
    lesson: {
      ...
      parentTip: "Measurement error is a topic that rewards real physical experience over textbook problems. If you have a ruler and a tape measure at home, try measuring the same object multiple times with each — you will almost certainly get slightly different readings. This makes the abstract idea of absolute error concrete. The distinction between absolute and relative error is genuinely subtle, so do not rush past it. Ask your teenager to explain the difference to you using two very different-sized quantities — that comparison is what makes the concept click rather than just memorising definitions. Common misconception: students often confuse absolute error with percentage error — an absolute error of 2 cm might be negligible when measuring a room (0.05%) but significant when measuring a paperclip (40%). Percentage error provides context that absolute error does not. Another issue is that students assume more decimal places mean more accuracy — writing 3.14159 m when the measurement tool only measures to the nearest cm gives a false sense of precision. Your child is ready for the worksheet when they can: (1) calculate absolute and percentage error, (2) express a measurement with an appropriate degree of precision, (3) determine the upper and lower bounds of a measurement given its precision, and (4) explain why measurement errors accumulate in multi-step calculations.",
    ...
    activities: [
      ...
      {
        type: "open-response",
        title: "Percentage Error in Real Measurements",
        instruction: "Calculate and compare percentage errors in practical contexts.",
        prompts: [
          { text: "A student measures the length of a table as 1.48 m. The actual length is 1.50 m. Calculate the absolute error and percentage error.", type: "lines", lines: 4 },
          { text: "A digital scale has an accuracy of ±0.5 g. When weighing a 50 g object, what is the maximum percentage error?", type: "lines", lines: 3 },
          { text: "Discuss: is a 5% error acceptable when measuring: (a) ingredients in cooking, (b) a drug dose, (c) a room for new furniture? Explain your reasoning.", type: "lines", lines: 4 },
        ],
      },
      {
        type: "sorting",
        title: "Proportional Contexts — Direct or Inverse?",
        instruction: "Sort each context into the correct column.",
        columns: ["Direct proportion", "Inverse proportion"],
        items: [
          { label: "Petrol consumption and distance driven" },
          { label: "Speed and travel time for a fixed distance" },
          { label: "Number of workers and time to complete a task" },
          { label: "Cost and number of items bought at same price" },
          { label: "Pressure and volume of a gas at fixed temperature" },
          { label: "Side length and perimeter of a regular pentagon" },
        ],
      },
      {
        type: "open-response",
        title: "Rates and Unit Rates",
        instruction: "Calculate and compare rates in real-world contexts.",
        prompts: [
          { text: "Car A uses 8 L per 100 km. Car B uses 6.5 L per 100 km. Over 15,000 km, how much more fuel does Car A use? At $2.10/L, what is the extra annual cost?", type: "lines", lines: 5 },
          { text: "Supermarket A sells 2 kg of rice for $4.80. Supermarket B sells 5 kg for $11.50. Find the unit rate for each. Which is better value?", type: "lines", lines: 4 },
          { text: "A tap drips at a rate of 12 mL per minute. How many litres per day? Per year? How much does this cost if water is charged at $3.50/kL?", type: "lines", lines: 4 },
        ],
      },
      {
        type: "sorting",
        title: "Measurement Precision — Which Instrument?",
        instruction: "Sort each measurement task to the most appropriate measuring instrument.",
        columns: ["Ruler/tape measure", "Digital scale", "Measuring cylinder", "Vernier caliper"],
        items: [
          { label: "Mass of a 50 g weight" },
          { label: "Inner diameter of a pipe" },
          { label: "Length of a room" },
          { label: "Volume of liquid in a beaker" },
          { label: "Thickness of a coin" },
          { label: "Mass of ingredients in a recipe" },
        ],
      },
      {
        type: "open-response",
        title: "Currency Exchange and Commission",
        instruction: "Apply ratio and proportion to currency conversion.",
        prompts: [
          { text: "The AUD/USD exchange rate is 0.64. Convert $1,500 AUD to USD.", type: "lines", lines: 2 },
          { text: "A currency exchange charges 2.5% commission. How much USD do you actually receive for $1,500 AUD after commission?", type: "lines", lines: 3 },
          { text: "On a return trip, you convert 800 USD back to AUD at a rate of 0.65 (with 2.5% commission). How much AUD do you receive?", type: "lines", lines: 3 },
          { text: "Why do banks offer different buy and sell rates for foreign currency? What is the 'spread'?", type: "lines", lines: 3 },
        ],
      },
    ],
  ...
  // ── WS 8: Deductive Reasoning & Geometric Theorems ────────────
  {
    ...
    activities: [
      ...
      {
        type: "open-response",
        title: "Angle Relationships in Parallel Lines",
        instruction: "Apply angle theorems for parallel lines cut by a transversal.",
        prompts: [
          { text: "Define and distinguish between: (a) corresponding angles, (b) alternate interior angles, (c) co-interior (same-side interior) angles.", type: "lines", lines: 5 },
          { text: "Two parallel lines are cut by a transversal. One angle is 73°. Find all eight angles formed. Justify each using a theorem.", type: "lines", lines: 6 },
          { text: "Prove that co-interior angles between parallel lines are supplementary, using the properties of straight angles and alternate angles.", type: "lines", lines: 5 },
        ],
      },
      {
        type: "sorting",
        title: "Proof Statements — Logical Order",
        instruction: "Sort these proof steps into the correct logical order to prove that the base angles of an isosceles triangle are equal.",
        columns: ["Step 1", "Step 2", "Step 3", "Step 4"],
        items: [
          { label: "Therefore angle ABC = angle ACB (corresponding parts of congruent triangles)" },
          { label: "Let triangle ABC have AB = AC. Draw the angle bisector from A to BC, meeting BC at M." },
          { label: "In triangles ABM and ACM: AB = AC (given), angle BAM = angle CAM (construction), AM is common" },
          { label: "Therefore triangles ABM and ACM are congruent (SAS)" },
        ],
      },
      {
        type: "open-response",
        title: "Similarity and Scale Factors",
        instruction: "Apply similarity to find unknown lengths and areas.",
        prompts: [
          { text: "Two similar rectangles have widths 6 cm and 9 cm. If the smaller has length 8 cm, find the length of the larger.", type: "lines", lines: 3 },
          { text: "Two similar triangles have sides in ratio 3:5. If the area of the smaller is 27 cm², find the area of the larger. Explain why the area ratio is not 3:5.", type: "lines", lines: 4 },
          { text: "A photograph is 10 cm × 15 cm. It is enlarged so the longer side becomes 24 cm. Is the enlarged image similar to the original? Find the shorter side.", type: "lines", lines: 4 },
        ],
      },
      {
        type: "home-activity",
        title: "Geometric Reasoning in Design and Art",
        instruction: "Discover how geometric theorems appear in art, design, and architecture.",
        suggestions: [
          "Research how M.C. Escher used tessellations and geometric transformations in his art. Write about one work and the mathematical ideas it uses.",
          "Find an example of the Golden Ratio in architecture or nature (e.g. the Parthenon, nautilus shells). Write about the proportions and why they are considered aesthetically pleasing.",
          "Draw a design using only a ruler and compass (compass-and-straightedge construction). Research what shapes can and cannot be constructed this way.",
          "Research a famous geometric proof from history (e.g. Euclid's proof that there are infinitely many primes). Write a short summary in your own words.",
          "Create a geometric proof poster showing one theorem, its diagram, and a step-by-step proof. Explain it to a family member.",
        ],
      },
    ],
  ...
  // ── WS 9: Networks, Paths & Connectedness ─────────────────────
  {
    ...
    activities: [
      ...
      {
        type: "sorting",
        title: "Classify Real-World Networks",
        instruction: "Sort each real-world network into the correct type.",
        columns: ["Undirected unweighted", "Undirected weighted", "Directed unweighted", "Directed weighted"],
        items: [
          { label: "Facebook friendships (mutual connections)" },
          { label: "Road map between towns with km distances" },
          { label: "Twitter follows (one-way connections)" },
          { label: "Water pipe network with flow capacities" },
          { label: "Web pages with hyperlinks" },
          { label: "One-way street system with speed limits" },
        ],
      },
      ...
      // M6 — matching: graph property → Euler path/circuit/neither
      {
        ...
        instruction: "Sort each set of vertex degrees by whether the connected graph has an Euler circuit, an Euler path (not circuit), or neither.",
        columns: ["Euler circuit", "Euler path (not circuit)", "Neither"],
        items: [
          { label: "Degrees: 2, 2, 2, 2" },
          { label: "Degrees: 3, 3, 2, 2" },
          { label: "Degrees: 3, 3, 3, 3" },
          { label: "Degrees: 4, 4, 2, 2, 2" },
          { label: "Degrees: 1, 1, 2" },
          { label: "Degrees: 3, 5, 3, 3" },
        ],
      },
      ...
      },
      {
        ...
        instruction: "Apply Dijkstra's shortest path algorithm manually.",
        prompts: [
          { text: "Explain Dijkstra's algorithm in your own words. What problem does it solve?", type: "lines", lines: 3 },
          { text: "Using this network: A–B: 4, A–C: 2, B–D: 5, C–B: 1, C–D: 8, D–E: 3. Apply Dijkstra's algorithm to find the shortest path from A to E. Show each step.", type: "lines", lines: 8 },
          { text: "What is the shortest path and its total distance? List the vertices in order.", type: "lines", lines: 2 },
        ],
      },
      {
        type: "open-response",
        title: "Critical Path Analysis",
        instruction: "Apply critical path analysis to project planning.",
        prompts: [
          { text: "Explain what a critical path is and why project managers use it.", type: "lines", lines: 3 },
          { text: "A project has tasks: A(3 days, start first), B(2 days, after A), C(4 days, after A), D(1 day, after B and C), E(2 days, after D). Draw the network and find the critical path.", type: "box" },
          { text: "What is the minimum time to complete the project? Which tasks have float (slack time)?", type: "lines", lines: 4 },
          { text: "If task C is delayed by 1 day, does this change the critical path? Explain.", type: "lines", lines: 3 },
        ],
      },
      {
        type: "sorting",
        title: "Network Terminology — True or False",
        instruction: "Sort each statement as True or False about networks.",
        columns: ["True", "False"],
        items: [
          { label: "A tree with n vertices has n−1 edges" },
          { label: "Every connected graph has an Euler circuit" },
          { label: "A complete graph K₄ has 6 edges" },
          { label: "In a directed graph (digraph), edges have no direction" },
          { label: "A planar graph can be drawn without edge crossings" },
          { label: "The degree of a vertex equals the number of edges at that vertex" },
        ],
      },
      {
        type: "open-response",
        title: "Graph Colouring",
        instruction: "Apply graph colouring to scheduling and map problems.",
        prompts: [
          { text: "Explain what graph colouring means and what the chromatic number of a graph represents.", type: "lines", lines: 3 },
          { text: "A university needs to schedule 5 exams. Subjects that share students cannot be scheduled at the same time. Draw a conflict graph and determine the minimum number of time slots needed.", type: "box" },
          { text: "Research the Four Colour Theorem. State the theorem and explain why it is significant.", type: "lines", lines: 4 },
        ],
      },
      {
        type: "matching",
        title: "Graph Theory — Historical Connections",
        instruction: "Match each graph theory concept to its historical origin or key mathematician.",
        left: ["Euler paths", "Planar graphs", "Four Colour Theorem", "Minimum spanning tree", "Dijkstra's algorithm", "Travelling salesman problem"],
  ...
  // ── WS 10: Bivariate Data & Scatter Plots ─────────────────────
  {
    ...
    activities: [
      ...
      },
      {
        ...
        instruction: "Understand and calculate Pearson's r.",
        prompts: [
          { text: "Explain what Pearson's correlation coefficient r measures. What are its maximum and minimum values?", type: "lines", lines: 3 },
          { text: "For data: x = {2, 4, 6, 8, 10}, y = {5, 9, 13, 16, 21}. Calculate the mean of x and mean of y. Then calculate r using the formula or technology. Interpret the result.", type: "lines", lines: 6 },
          { text: "Can two variables have r ≈ 0 but still have a strong non-linear relationship? Explain and give an example.", type: "lines", lines: 4 },
        ],
      },
      {
        type: "matching",
        title: "Scatter Plot Vocabulary",
        instruction: "Match each scatter plot term to its correct description.",
        left: ["Response variable", "Explanatory variable", "Outlier", "Cluster", "Line of best fit", "Extrapolation"],
        right: ["Predicting outside the range of the data", "A point clearly separated from the main pattern", "Placed on the x-axis; independent variable", "Minimises the sum of squared residuals", "A group of points separate from others", "Placed on the y-axis; depends on x"],
      },
      {
        type: "open-response",
        title: "Confounding Variables and Study Design",
        instruction: "Identify confounding variables and distinguish study types.",
        prompts: [
          { text: "Define a confounding variable. Give an example of how a confounder could lead to a misleading correlation.", type: "lines", lines: 4 },
          { text: "A study finds that areas with more hospitals have higher death rates. Does this mean hospitals cause death? Identify the confounding variable.", type: "lines", lines: 3 },
          { text: "Explain the difference between an observational study and a randomised controlled experiment. Which one can establish causation?", type: "lines", lines: 4 },
          { text: "Design a controlled experiment to test whether lack of sleep causes lower test scores. Describe your key controls.", type: "lines", lines: 4 },
        ],
      },
    ],
  ...
  // ── WS 11: Media Bias & Statistical Analysis ──────────────────
  {
    ...
    lesson: {
      ...
      parentTip: "This lesson is about something that matters every day in adult life — evaluating claims made with statistics. Encourage your teenager to bring in real examples: a graph from a news website, a claim in an advertisement, or a statistic from social media. Analysing real examples is far more powerful than textbook ones. Your role as a parent is not to know whether the statistic is correct, but to model the habit of asking sceptical questions alongside your teenager: Who collected this data? Why? Who benefits from this conclusion? What is missing from the picture? These questioning habits are genuinely critical life skills. Common misconception: students often assume that statistics presented in media are objective and unbiased because they involve numbers. In fact, statistics can be manipulated through selective reporting, misleading graph scales, cherry-picked time periods, and correlation-causation confusion. Another common error is dismissing all statistics as untrustworthy rather than developing the skills to evaluate them critically. The goal is not cynicism but informed judgment. Your child is ready for the worksheet when they can: (1) identify at least 3 ways a statistic or graph could be misleading (truncated axis, cherry-picked data, missing context, misleading percentages), (2) evaluate a statistical claim by asking 'Who collected this data? How was it collected? What might be missing?', and (3) rewrite a misleading statistical claim in a more accurate way.",
    ...
    activities: [
      ...
      {
        type: "matching",
        title: "Sampling Methods — Match the Definition",
        instruction: "Draw a line from each sampling method to its description.",
        left: ["Simple random sample", "Stratified sample", "Systematic sample", "Convenience sample", "Cluster sample", "Voluntary response sample"],
        right: ["Every nth person on a list is selected", "Respondents choose themselves", "Groups are selected, then all members surveyed", "Population divided into groups, proportional sample from each", "Selecting whoever is easiest to reach", "Each member of population has equal chance of selection"],
      },
      {
        type: "open-response",
        title: "Evaluating Media Statistics",
        instruction: "Critically analyse statistical claims from media sources.",
        prompts: [
          { text: "Find or recall a headline that uses statistics (e.g. '9 out of 10 dentists recommend...'). Write the headline and identify two questions you would ask before accepting the claim.", type: "lines", lines: 4 },
          { text: "A poll reports: '65% of Australians support the new policy.' What information would you need about the poll before trusting this result?", type: "lines", lines: 4 },
          { text: "Explain how a graph with a truncated y-axis can mislead readers. Sketch an example showing how the same data looks very different depending on where the axis starts.", type: "box" },
        ],
      },
      {
        type: "sorting",
        title: "Statistical Bias — Identify the Type",
        instruction: "Sort each scenario into the type of bias it demonstrates.",
        columns: ["Sampling bias", "Response bias", "Measurement bias", "Publication bias"],
        items: [
          { label: "Asking shoppers at a mall about online shopping habits" },
          { label: "A question: 'Do you agree that the dangerous new road is unsafe?'" },
          { label: "Only publishing studies that show positive drug effects" },
          { label: "A bathroom scale that reads 2 kg too low" },
          { label: "Surveying students during school to find youth opinions" },
          { label: "Respondents overreporting their exercise frequency" },
        ],
      },
      {
        type: "open-response",
        title: "Box Plots and Comparing Distributions",
        instruction: "Construct and interpret box plots to compare data sets.",
        prompts: [
          { text: "Calculate the five-number summary (min, Q1, median, Q3, max) for this data set: 12, 15, 18, 21, 24, 27, 30, 33, 36. Show all working.", type: "lines", lines: 5 },
          { text: "Draw a box plot for the data above. Label all five key values.", type: "box" },
          { text: "A second class has a box plot with median 20, IQR of 8, and a longer upper whisker. Compare the two distributions in terms of centre, spread, and skewness.", type: "lines", lines: 4 },
        ],
      },
      {
        type: "tally-chart",
        title: "Types of Misleading Graphs Encountered",
        instruction: "Tally each type of misleading graph technique you identified in media examples.",
        categories: [
          { label: "Truncated y-axis", icon: "square", count: 6 },
          { label: "3D distortion", icon: "cube", count: 4 },
          { label: "Cherry-picked time period", icon: "apple", count: 3 },
          { label: "Missing data labels", icon: "pencil", count: 5 },
          { label: "Sample size not reported", icon: "book", count: 4 },
        ],
      },
      {
        type: "open-response",
        title: "Standard Deviation and Spread",
        instruction: "Calculate and interpret standard deviation.",
        prompts: [
          { text: "Explain what standard deviation measures in plain language. Why is it more useful than the range?", type: "lines", lines: 3 },
          { text: "Calculate the mean and standard deviation for: 4, 7, 7, 9, 11. Show all steps.", type: "lines", lines: 6 },
          { text: "Class A has mean = 72 and sd = 4. Class B has mean = 72 and sd = 12. What does this tell you about the two classes?", type: "lines", lines: 3 },
          { text: "If a new student who scored 90 joins Class A, what effect would this have on the mean and standard deviation?", type: "lines", lines: 3 },
        ],
      },
      {
        type: "open-response",
        title: "Designing a Statistical Investigation",
        instruction: "Plan a complete statistical investigation from question to conclusion.",
        prompts: [
          { text: "Write a research question you could investigate with secondary data available online (e.g. ABS, Bureau of Meteorology).", type: "lines", lines: 2 },
          { text: "Describe your data collection plan: source, variables, sample size, and any potential biases.", type: "lines", lines: 4 },
          { text: "List three statistical tools (e.g. mean, scatter plot, box plot) you would use to analyse the data and explain why each is appropriate.", type: "lines", lines: 4 },
          { text: "Describe how you would present your findings to a non-mathematical audience. What visualisations would you use and why?", type: "lines", lines: 4 },
        ],
      },
      {
        type: "home-activity",
        title: "Statistical Literacy in the Media",
        instruction: "Become a critical consumer of statistics in everyday life.",
        suggestions: [
          "Collect three news articles this week that include statistics. For each, write one question you would ask about the data before accepting the claim.",
          "Compare how the same statistic is reported by two different news sources. Do they interpret it the same way? Write about any differences.",
          "Watch or read an advertisement that uses statistics. Identify any misleading techniques used. Write a more honest version.",
          "Research a case study where bad statistics led to a wrong conclusion (e.g. early cholesterol research, the MMR vaccine panic). Write a summary.",
          "Interview a family member or friend about a statistic they recently heard. Help them evaluate whether the claim is trustworthy.",
        ],
      },
      {
        type: "open-response",
        title: "Mean, Median, and Mode in Context",
        instruction: "Choose and justify the best measure of centre for different data sets.",
        prompts: [
          { text: "The weekly wages of 6 employees are: $800, $820, $850, $900, $920, $5,500. Calculate the mean, median, and mode.", type: "lines", lines: 5 },
          { text: "Which measure best represents the 'typical' wage? Why does the mean give a misleading picture here?", type: "lines", lines: 3 },
          { text: "A real estate agent reports the 'average' house price in a suburb as $1.2 million. Do you think this is a mean or median? Which would you prefer to know as a home buyer?", type: "lines", lines: 4 },
        ],
      },
      {
        type: "open-response",
        title: "Margin of Error and Confidence",
        instruction: "Interpret margins of error in survey results.",
        prompts: [
          { text: "A poll reports: '48% of voters support the policy, with a margin of error of ±3%.' Write the confidence interval this implies.", type: "lines", lines: 2 },
          { text: "Another candidate receives 46% support. Can you conclude the first candidate is ahead? Explain.", type: "lines", lines: 3 },
          { text: "Explain how increasing the sample size affects the margin of error. What happens to the margin of error if you quadruple the sample size?", type: "lines", lines: 4 },
          { text: "Why do political polls sometimes give very different results from the actual election outcome? List three possible reasons.", type: "lines", lines: 4 },
        ],
      },
      {
        type: "matching",
        title: "Statistical Terms — Match to Definition",
        instruction: "Match each statistical term to its definition.",
        left: ["Population", "Sample", "Parameter", "Statistic", "Census", "Sampling frame"],
  ...
  // ── WS 12: Conditional Probability & Compound Events ──────────
  {
    ...
    lesson: {
      ...
      parentTip: "Conditional probability is conceptually one of the most demanding topics in Year 10 — even many adults find it counterintuitive. The key is to slow down and always ask together: has the situation changed since the last event happened? With drawing without replacement, the bag physically changes. With a coin toss, it does not. Using real physical objects — actually pulling coloured counters from a bag — is far more effective than abstract calculation at first. If the notation P(A|B) feels confusing, translate it into plain English every time: the probability of A, given that B has already happened. Common misconception: students frequently confuse P(A and B) with P(A|B) — the probability of both events happening is not the same as the probability of A given that B has already happened. A tree diagram with updated probabilities on the second branch is the clearest way to show conditional probability. Another common error is applying the multiplication rule for independent events to dependent events without adjusting the second probability. Your child is ready for the worksheet when they can: (1) distinguish between independent and dependent events, (2) calculate conditional probability using a tree diagram or two-way table, (3) apply the multiplication rule correctly for both independent and dependent events, and (4) explain in their own words what 'given that' means in a probability context.",
    ...
    activities: [
      ...
      {
        type: "matching",
        title: "Probability Rules — Match the Formula",
        instruction: "Draw a line from each probability rule to its formula.",
        left: ["Addition rule (mutually exclusive)", "Addition rule (general)", "Multiplication rule (independent)", "Multiplication rule (dependent)", "Complement rule", "Conditional probability"],
        right: ["P(A|B) = P(A∩B) / P(B)", "P(A∪B) = P(A) + P(B) − P(A∩B)", "P(A') = 1 − P(A)", "P(A∩B) = P(A) × P(B|A)", "P(A∪B) = P(A) + P(B)", "P(A∩B) = P(A) × P(B)"],
      },
      {
        type: "open-response",
        title: "Two-Way Tables and Probability",
        instruction: "Use a two-way frequency table to calculate probabilities.",
        prompts: [
          { text: "A school surveyed 200 students about sport preference. 80 males: 50 like football, 30 like swimming. 120 females: 40 like football, 80 like swimming. Construct a two-way table.", type: "box" },
          { text: "Using your table, find: (a) P(female) (b) P(likes football) (c) P(male and likes swimming) (d) P(likes swimming | female)", type: "lines", lines: 6 },
          { text: "Are sport preference and gender independent in this dataset? Justify using probabilities.", type: "lines", lines: 4 },
        ],
      },
      {
        type: "sorting",
        title: "Classify Events as Independent or Dependent",
        instruction: "Sort each pair of events as independent or dependent.",
        columns: ["Independent", "Dependent"],
        items: [
          { label: "Drawing two cards without replacement" },
          { label: "Rolling a die and flipping a coin" },
          { label: "Choosing a chocolate then choosing another without replacing" },
          { label: "Two separate people each flipping their own coin" },
          { label: "Rain on Saturday and rain on Sunday" },
          { label: "Drawing a card, replacing it, drawing again" },
        ],
      },
      {
        type: "open-response",
        title: "Tree Diagrams for Multi-Stage Events",
        instruction: "Use tree diagrams to calculate compound probabilities.",
        prompts: [
          { text: "A bag contains 3 red and 2 blue marbles. Draw a tree diagram for drawing two marbles without replacement. Label all branches with probabilities.", type: "box" },
          { text: "Using your tree diagram, find: (a) P(both red) (b) P(both blue) (c) P(one of each colour)", type: "lines", lines: 5 },
          { text: "How would the tree diagram change if the first marble was replaced before drawing the second? Recalculate the probabilities.", type: "lines", lines: 4 },
        ],
      },
      {
        type: "tally-chart",
        title: "Probability Concepts Used This Week",
        instruction: "Tally each probability concept you applied during this unit.",
        categories: [
          { label: "Complementary probability", icon: "circle", count: 5 },
          { label: "Conditional probability", icon: "diamond", count: 6 },
          { label: "Tree diagrams", icon: "tree", count: 7 },
          { label: "Two-way tables", icon: "square", count: 5 },
          { label: "Venn diagrams", icon: "heart", count: 4 },
        ],
      },
      {
        type: "open-response",
        title: "Bayes' Theorem — Introduction",
        instruction: "Apply Bayes' theorem to update probabilities based on new information.",
        prompts: [
          { text: "State Bayes' theorem: P(A|B) = P(B|A) × P(A) / P(B). Explain each term in the formula.", type: "lines", lines: 4 },
          { text: "A medical test for a disease is 95% accurate. The disease affects 1% of the population. If someone tests positive, find the probability they actually have the disease. Show full working using Bayes' theorem.", type: "lines", lines: 8 },
          { text: "Why is the result of the medical test example surprising? What does it tell us about the importance of base rates?", type: "lines", lines: 4 },
        ],
      },
      {
        type: "open-response",
        title: "Expected Value and Fairness",
        instruction: "Calculate expected values and determine if games are fair.",
        prompts: [
          { text: "Define expected value (E) for a probability distribution. Write the general formula.", type: "lines", lines: 3 },
          { text: "A game costs $5 to play. You win $20 with probability 0.15, $5 with probability 0.30, and $0 otherwise. Calculate the expected profit (or loss) per game.", type: "lines", lines: 5 },
          { text: "Is the game 'fair'? Explain what fairness means in terms of expected value.", type: "lines", lines: 3 },
          { text: "Design your own fair game with three outcomes. Show that the expected value equals the entry cost.", type: "lines", lines: 5 },
        ],
      },
      {
        type: "home-activity",
        title: "Probability in Everyday Life",
        instruction: "Explore how probability and risk affect real decisions.",
        suggestions: [
          "Research how insurance companies use probability to set premiums. Write a paragraph explaining the concept of 'expected loss'.",
          "Play a board game that involves dice or cards with a family member. Record outcomes and compare experimental probability with theoretical probability over 30 trials.",
          "Find an example of conditional probability in a news article (e.g. medical screening, weather forecasting). Explain the probabilities used.",
          "Research the 'Birthday Paradox' — the probability that two people in a group share a birthday. Calculate the probability for a group of 23 people.",
          "Investigate how poker players or chess players use probability and expected value to make decisions. Write a short summary of the strategies used.",
        ],
      },
      {
        type: "open-response",
        title: "Simulating Probability Experiments",
        instruction: "Use simulation to estimate probabilities and compare with theory.",
        prompts: [
          { text: "Describe how you could use a random number generator to simulate rolling a fair die 100 times. What would you record?", type: "lines", lines: 3 },
          { text: "Simulate flipping a coin 50 times using a random method (coin, calculator, or app). Record your results and calculate the experimental probability of heads.", type: "lines", lines: 3 },
          { text: "Compare your experimental result to the theoretical probability of 0.5. Calculate the absolute difference and explain whether you expected this level of variation.", type: "lines", lines: 4 },
          { text: "How would increasing the number of trials (e.g. to 1000) affect the experimental probability? Explain using the Law of Large Numbers.", type: "lines", lines: 4 },
        ],
      },
      {
        type: "open-response",
        title: "Venn Diagrams and Set Notation",
        instruction: "Use Venn diagrams and set notation to organise and calculate probabilities.",
        prompts: [
          { text: "In a group of 30 students: 18 play sport, 12 play music, 7 play both. Draw a Venn diagram with all four regions labelled.", type: "box" },
          { text: "Using the Venn diagram: find P(sport only), P(music only), P(sport or music), P(neither).", type: "lines", lines: 4 },
          { text: "Write the addition rule in set notation: P(A ∪ B) = ... and verify it using your Venn diagram.", type: "lines", lines: 3 },
        ],
      },
      {
        type: "open-response",
        title: "Mutually Exclusive and Exhaustive Events",
        instruction: "Identify and work with mutually exclusive and exhaustive events.",
        prompts: [
          { text: "Define mutually exclusive events. Give two examples from a deck of cards.", type: "lines", lines: 3 },
          { text: "Define exhaustive events. Give an example of a set of exhaustive events when rolling a die.", type: "lines", lines: 3 },
          { text: "Are 'drawing a heart' and 'drawing a red card' mutually exclusive? Explain and calculate P(heart or red).", type: "lines", lines: 4 },
          { text: "If events A and B are mutually exclusive and exhaustive, what must P(A) + P(B) equal? Why?", type: "lines", lines: 2 },
        ],
      },
      {
        type: "sorting",
        title: "Probability Value — Classify the Event",
        instruction: "Sort each event by its approximate probability.",
        columns: ["Very unlikely (0–0.1)", "About even (0.4–0.6)", "Very likely (0.9–1.0)"],
        items: [
          { label: "Rolling a 6 on a fair die" },
          { label: "The sun rising tomorrow" },
          { label: "Drawing a red card from a standard deck" },
          { label: "Winning a lottery with 1 ticket" },
          { label: "Flipping heads on a fair coin" },
          { label: "Someone in Australia being alive tomorrow" },
        ],
      },
      {
        type: "open-response",
        title: "Permutations and Combinations Introduction",
        instruction: "Begin exploring counting methods for probability calculations.",
        prompts: [
          { text: "Explain the difference between a permutation and a combination. When does order matter?", type: "lines", lines: 3 },
          { text: "How many ways can 5 students be arranged in a row for a photo? Show the calculation.", type: "lines", lines: 3 },
          { text: "A committee of 3 is chosen from 8 people. How many possible committees are there? Use the combination formula.", type: "lines", lines: 4 },
          { text: "A PIN uses 4 different digits from 0–9. How many different PINs are possible? Compare this to allowing repeated digits.", type: "lines", lines: 4 },
        ],
      },
    ],
  },
