...
export const year7EnglishWorksheets: WorksheetItem[] = [
  ...
  // ── WS 6: Visual Literacy and Multimodal Texts
  {
    ...
    lesson: {
      ...
      parentTip:
        "Visual literacy is increasingly important in a world saturated with images. The skills practised here — identifying salience, gaze, angle, and the image-text relationship — apply directly to evaluating social media, news media, advertising, and political messaging. Make this real by discussing images your child encounters in daily life. Common misconception: students often analyse visual texts by simply describing what they see ('there is a person standing in front of a building') rather than interpreting what the visual choices mean ('the low camera angle makes the figure appear powerful and dominant'). The shift from description to analysis is the key skill here. Another common error is treating visual elements in isolation rather than considering how they work together — colour, composition, gaze, and text all contribute to a unified message. Your child is ready for the worksheet when they can: (1) identify at least 3 visual techniques in a multimodal text (colour, framing, salience, vectors, gaze, layout), (2) explain what effect each technique has on the viewer, and (3) write an analytical sentence that connects a visual choice to its intended meaning using the structure: 'The [technique] creates a sense of [effect] because [reason].'.",
      extension:
