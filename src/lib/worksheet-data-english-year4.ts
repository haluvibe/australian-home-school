...
export const year4EnglishWorksheets: WorksheetItem[] = [
  ...
  },
  {
    ...
    activities: [
      ...
      // ── EXTENDING CONTINUED (76–100) ─────────────────────────────────────
      {
        type: "fill-in-blank" as const,
        title: "Figurative Language in Speeches and Public Writing",
        instruction: "Fill in the blank with a figurative language technique that would suit a persuasive speech or public writing.",
        parentTip: "Politicians, advocates and public speakers use figurative language to make their messages memorable and emotionally powerful.",
        sentences: [
          { text: "Our country stands at a ___ , and we must choose which path to take. (Use a metaphor)", blanks: ["crossroads"] },
          { text: "Our children's futures are ___ in our hands right now. (Use a metaphor)", blanks: ["seeds / clay / candles"] },
          { text: "Like a ship without a rudder, our community has been ___ without clear leadership. (Complete the simile)", blanks: ["drifting / steering blind / lost at sea"] },
          { text: "The problem is not ___ — it is an avalanche that will bury us if we wait. (Correct this mixed metaphor)", blanks: ["a snowflake"] },
        ],
      },
      {
        type: "true-false" as const,
        title: "Figurative Language: Writer's Craft",
        instruction: "Read each statement about using figurative language as a writer.",
        statements: [
          { text: "Mixing incompatible metaphors in a single sentence ('the ship of state must iron out its problems') can confuse readers.", answer: true },
          { text: "Personification is more powerful in poetry than in prose.", answer: false },
          { text: "Reading widely is one of the best ways to build a repertoire of figurative language.", answer: true },
          { text: "Figurative language should be used in every sentence of a poem or story.", answer: false },
          { text: "The same figurative technique can create very different effects depending on the words chosen.", answer: true },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write a Description Using Only One Technique",
        instruction: "Write a description of a thunderstorm using ONLY personification — every sentence must give the storm a human quality. Write 6–8 sentences.",
        parentTip: "Constraining to a single technique forces creative depth — your child must find many different ways to personify the same thing.",
        prompts: [{ text: "My description:", type: "box", lines: 10 }],
      },
      {
        type: "sorting" as const,
        title: "Sort: Which Technique Creates This Effect?",
        instruction: "Match each desired effect to the figurative technique most likely to create it.",
        columns: ["Simile", "Metaphor", "Personification", "Sensory imagery"],
        items: [
          { label: "Make an abstract idea (like grief) feel physical and concrete." },
          { label: "Help the reader feel they are inside the experience — smelling, tasting, touching." },
          { label: "Draw a clear, explicit comparison between two unlike things." },
          { label: "Give nature or an object an emotional quality that mirrors the character's feelings." },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Figurative Language: Revision Quiz",
        instruction: "Choose the best answer for each question.",
        questions: [
          { prompt: "Which best describes an extended metaphor?", options: ["A metaphor used once.", "A metaphor developed across several sentences or a whole text.", "A metaphor with 'like' or 'as'."], answer: "A metaphor developed across several sentences or a whole text." },
          { prompt: "What is the difference between a simile and a metaphor?", options: ["Similes are only used in poetry; metaphors are used in prose.", "Similes use 'like' or 'as'; metaphors state a direct comparison.", "There is no difference."], answer: "Similes use 'like' or 'as'; metaphors state a direct comparison." },
          { prompt: "Which sentence uses personification?", options: ["The night was as dark as ink.", "The night wrapped its arms around the sleeping city.", "It was a very dark night."], answer: "The night wrapped its arms around the sleeping city." },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write a Descriptive Paragraph Using Four Techniques",
        instruction: "Write a descriptive paragraph about a city street at night. Include at least one simile, one metaphor, one personification, and two sensory images. Label each technique in the margin.",
        prompts: [{ text: "My paragraph:", type: "box", lines: 10 }],
      },
      {
        type: "circle-correct" as const,
        title: "Which Technique Is More Effective Here?",
        instruction: "Read each pair and circle the more effective use of figurative language.",
        questions: [
          {
            prompt: "Describing anger:",
            options: [
          ...
          {
            prompt: "Describing a busy market:",
            options: [
      ...
      {
        type: "fill-in-blank" as const,
        title: "Australian Figurative Language — Complete the Image",
        instruction: "Complete each Australian-themed figurative expression with a vivid, specific word or phrase.",
        parentTip: "Encourage your child to draw on Australian places, animals and experiences for their comparisons.",
        sentences: [
          { text: "The outback sun was ___ — relentless, unblinking, turning the red earth to fire.", blanks: ["an eye / a furnace / a forge"] },
          { text: "The Great Barrier Reef was a ___ of impossible colour beneath the turquoise glass of the sea.", blanks: ["cathedral / mosaic / tapestry"] },
          { text: "The magpie's call ___ through the early morning like a reminder that the world was still alive.", blanks: ["poured / rang / threaded"] },
          { text: "The gum trees stood ___ in the heat, their silver leaves turned sideways against the glare.", blanks: ["still / patient / silent"] },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write a Poem About an Australian Place",
        instruction: "Write a poem of 10–12 lines about an Australian landscape — the outback, the Snowy Mountains, the Kimberley, a reef, a city at night. Use at least four different figurative language techniques. Label each one.",
        prompts: [
          { text: "My place:", type: "lines", lines: 1 },
          { text: "My poem:", type: "box", lines: 14 },
        ],
      },
      {
        type: "matching" as const,
        title: "Match Poem Line to Technique",
        instruction: "Match each line of poetry to the figurative language technique it uses.",
        parentTip: "Some lines may use more than one technique — choose the dominant one.",
        left: [
      ...
      {
        type: "true-false" as const,
        title: "Final Figurative Language Check",
        instruction: "Read each statement and decide true or false.",
        statements: [
          { text: "Personification is technically a type of metaphor.", answer: true },
          { text: "You should always explain what your figurative language means immediately after writing it.", answer: false },
          { text: "The most effective figurative language often draws on specific, personal experiences.", answer: true },
          { text: "Figurative language is only powerful in long texts — it cannot work in a single sentence.", answer: false },
          { text: "Good figurative language leaves a little space for the reader's imagination.", answer: true },
        ],
      },
      {
        type: "open-response" as const,
        title: "Final Reflection: Your Figurative Language Journey",
        instruction: "Write a reflection (4–5 sentences) on what you have learned about figurative language. Include: one technique you found challenging, one you feel confident with, and one piece of figurative language you are proud of creating during this unit.",
        prompts: [{ text: "My reflection:", type: "box", lines: 8 }],
      },
      {
        type: "open-response" as const,
        title: "Create Your Figurative Language Showcase",
        instruction: "Choose your three best pieces of figurative language from across this worksheet — one simile, one metaphor, and one personification. Write each one out beautifully, label the technique, and explain in one sentence what effect it creates.",
        parentTip: "Creating a showcase encourages your child to evaluate their own work and take ownership of their best writing.",
        prompts: [
          { text: "My best simile:\nEffect:", type: "lines", lines: 3 },
          { text: "My best metaphor:\nEffect:", type: "lines", lines: 3 },
          { text: "My best personification:\nEffect:", type: "lines", lines: 3 },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Figurative Language: Final Mastery Check",
        instruction: "Choose the best answer for each question.",
        questions: [
          { prompt: "Synaesthesia describes:", options: ["Repeating initial consonant sounds.", "Mixing the senses in a description (e.g. a loud colour).", "Comparing two things using 'like'."], answer: "Mixing the senses in a description (e.g. a loud colour)." },
          { prompt: "Which is an example of 'show, don't tell'?", options: ["She was cold.", "She was extremely cold.", "Her fingers had gone white at the knuckles and her teeth chattered like a telegraph machine."], answer: "Her fingers had gone white at the knuckles and her teeth chattered like a telegraph machine." },
          { prompt: "The best figurative language is:", options: ["Familiar and reassuring.", "Surprising, specific and fresh.", "As complicated as possible."], answer: "Surprising, specific and fresh." },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write a Poem: Free Choice",
        instruction: "Write a poem of 12–16 lines on any topic you choose. This is your most polished, ambitious poem of the unit. Use at least five different figurative language techniques and label each one. Aim for originality — surprise the reader.",
        parentTip: "Read the finished poem aloud together. Celebrate the craft, the surprise and the beauty of the language.",
        prompts: [
          { text: "My topic:", type: "lines", lines: 1 },
          { text: "My poem:", type: "box", lines: 18 },
        ],
      ...
      {
        type: "circle-correct" as const,
        title: "Figurative Language: Spot the Strongest Example",
        instruction: "For each set, circle the example that uses figurative language most effectively.",
        questions: [
          {
            prompt: "Describing a summer afternoon:",
            options: [
          ...
          {
            prompt: "Describing the ocean at night:",
            options: [
          ...
          {
            prompt: "Describing an empty house:",
            options: [
      ...
      {
        type: "home-activity" as const,
        title: "Poet in Residence — Final Week",
        instruction: "Bring together everything you have learned about figurative language in a creative project of your choice.",
        parentTip: "Display or share the finished work. Writing for an audience — even just family — transforms how students approach craft and takes pride in the result.",
        suggestions: [
          "Write a collection of five very short poems (2–4 lines each), each using a single figurative technique — simile, metaphor, personification, imagery, synaesthesia.",
          "Write a story opening (one paragraph) that establishes a powerful sense of place using figurative language.",
          "Read a poem aloud, record it, and listen back — notice how the figurative language sounds when spoken.",
          "Find one Australian poem you love and write a paragraph analysing its figurative language techniques and their effects.",
          "Create an illustrated poster of your five favourite pieces of figurative language from this unit.",
        ],
      },
      {
        type: "fill-in-blank" as const,
        title: "Figurative Language in Science Writing",
        instruction: "Good science writing uses figurative language to explain complex ideas. Fill in a vivid comparison for each scientific explanation.",
        parentTip: "Scientists from Richard Feynman to David Attenborough have used figurative language brilliantly to explain science. Discuss examples together.",
        sentences: [
          { text: "An atom is so small that a billion of them could fit side by side across a human hair — like lining up ___ across a ___.", blanks: ["a billion / dots", "single strand"] },
          { text: "The Earth's core is as hot as ___ .", blanks: ["the surface of the sun"] },
          { text: "DNA is like a ___ containing all the instructions for building and running a living thing.", blanks: ["blueprint / recipe / instruction manual"] },
          { text: "The brain processes information so quickly it is like having ___ computers working simultaneously.", blanks: ["billions of tiny"] },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write Figurative Language About a Science Concept",
        instruction: "Choose a science concept you have been studying. Write four sentences — one simile, one metaphor, one personification and one sensory image — to explain or describe it.",
        prompts: [
          { text: "My science concept:", type: "lines", lines: 1 },
          { text: "Simile:", type: "lines", lines: 2 },
          { text: "Metaphor:", type: "lines", lines: 2 },
          { text: "Personification:", type: "lines", lines: 2 },
          { text: "Sensory image:", type: "lines", lines: 2 },
        ],
      },
      {
        type: "circle-correct" as const,
        title: "Figurative Language: Identify the Technique",
        instruction: "Read each sentence and circle the correct technique.",
        questions: [
          { prompt: "'Hope is a bird that perches in the soul.'", options: ["Simile", "Metaphor", "Imagery"] },
          { prompt: "'She sings like a morning bird greeting the sun.'", options: ["Simile", "Metaphor", "Personification"] },
          { prompt: "'The fog came on little cat feet, sitting silent on its haunches.'", options: ["Simile", "Extended personification/metaphor", "Simile and imagery"] },
          { prompt: "'The fresh bread smelled of warm afternoons and childhood.'", options: ["Metaphor", "Sensory imagery", "Personification"] },
          { prompt: "'His anger was a kettle left on the flame too long.'", options: ["Simile", "Metaphor", "Personification"] },
          { prompt: "'The stars scattered like salt on black velvet.'", options: ["Metaphor", "Simile", "Imagery"] },
        ],
      },
      {
        type: "matching" as const,
        title: "Match the Technique to Its Definition",
        instruction: "Review: match each technique to the correct definition.",
        left: ["Simile", "Metaphor", "Personification", "Sensory imagery", "Extended metaphor", "Synaesthesia"],
        right: [
          "Language that appeals to the five senses.",
          "Gives human qualities to non-human things.",
      ...
      {
        type: "true-false" as const,
        title: "Figurative Language: Final True/False",
        instruction: "Consolidate your understanding with this final set of statements.",
        statements: [
          { text: "Figurative language can make abstract ideas feel concrete and real.", answer: true },
          { text: "A cliché is effective figurative language that has been used many times.", answer: false },
          { text: "The effect of figurative language depends on both the technique AND the specific words chosen.", answer: true },
          { text: "Personification always involves giving an animal human qualities.", answer: false },
          { text: "Reading widely is one of the best ways to develop a repertoire of fresh figurative language.", answer: true },
        ],
      },
      {
        type: "open-response" as const,
        title: "Figurative Language: Creative Writing Masterpiece",
        instruction: "Write a descriptive passage of 10–12 sentences about a significant place in your life — real or imagined. Use every figurative language technique you have learned: simile, metaphor, personification, sensory imagery, and extended metaphor. This is your most polished, ambitious piece of writing.",
        parentTip: "Read the finished piece aloud. Encourage your child to feel proud of the sophistication of their language — this is Year 4 writing at its best.",
        prompts: [
          { text: "My place:", type: "lines", lines: 1 },
          { text: "My passage:", type: "box", lines: 16 },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Figurative Language: Comprehensive Final Review",
        instruction: "Test your knowledge with this final review. Choose the best answer.",
        questions: [
          { prompt: "Which is an example of synaesthesia?", options: ["The sun rose like a coin.", "The music was a deep, bruised blue.", "The tree stood tall and silent."], answer: "The music was a deep, bruised blue." },
          { prompt: "What does 'show, don't tell' mean?", options: ["Use physical details and imagery rather than stating emotions directly.", "Include as many adjectives as possible.", "Only write about things you can see."], answer: "Use physical details and imagery rather than stating emotions directly." },
          { prompt: "Which example of personification is most effective?", options: ["The wind blew hard.", "The wind shoved its cold fingers through every gap in the fence.", "It was windy."], answer: "The wind shoved its cold fingers through every gap in the fence." },
        ],
      },
      {
        type: "open-response" as const,
        title: "Figurative Language: My Top Ten List",
        instruction: "Create a 'Top Ten Figurative Language Moments' list — ten pieces of figurative language from your own writing this unit that you are most proud of. Arrange them from 10 (good) to 1 (your personal best). For each, write the technique used.",
        parentTip: "A curated personal list encourages reflection, develops taste, and builds confidence in the child's own voice as a writer.",
        prompts: [
          { text: "10.", type: "lines", lines: 2 },
          { text: "9.", type: "lines", lines: 2 },
          { text: "8.", type: "lines", lines: 2 },
          { text: "7.", type: "lines", lines: 2 },
          { text: "6.", type: "lines", lines: 2 },
          { text: "My personal best — Number 1:", type: "lines", lines: 3 },
        ],
      },
    ],
  },
  {
    ...
    activities: [
      ...
      // ── EXTENDING CONTINUED (64–100) ─────────────────────────────────────
      {
        type: "fill-in-blank" as const,
        title: "Agreement with Compound Subjects",
        instruction: "Fill in the correct verb form when the sentence has a compound subject joined by 'and'.",
        parentTip: "When two subjects are joined by 'and', they usually take a plural verb.",
        sentences: [
          { text: "She and her brother ___ [go] to the same school.", blanks: ["go"] },
          { text: "Tom and I ___ [be – present] very good friends.", blanks: ["are"] },
          { text: "My dog and cat ___ [eat] from the same bowl.", blanks: ["eat"] },
          { text: "The teacher and the principal ___ [have] agreed.", blanks: ["have"] },
          { text: "She and he ___ [be – past] both late.", blanks: ["were"] },
        ],
      },
      {
        type: "circle-correct" as const,
        title: "Agreement with 'Or' and 'Nor'",
        instruction: "When subjects are joined by 'or' or 'nor', the verb agrees with the nearest subject. Circle the correct verb.",
        parentTip: "The 'proximity rule': with 'or/nor', the verb matches the subject closest to it.",
        questions: [
          { prompt: "Either she or her brothers ___ going.", options: ["is", "are"] },
          { prompt: "Neither the students nor the teacher ___ sure.", options: ["is", "are"] },
          { prompt: "Either the cat or the dog ___ the culprit.", options: ["is", "are"] },
          { prompt: "Neither she nor I ___ finished.", options: ["have", "has"] },
          { prompt: "Either he or you ___ right.", options: ["is", "are"] },
        ],
      },
      {
        type: "true-false" as const,
        title: "Agreement: Common Misconceptions",
        instruction: "Read each statement and decide if it is true or false.",
        statements: [
          { text: "When using 'and' to join two subjects, always use a plural verb.", answer: true },
          { text: "The word 'none' always takes a singular verb.", answer: false },
          { text: "Collective nouns like 'team' and 'committee' are typically singular in Australian English.", answer: true },
          { text: "'Data' in formal scientific writing is often treated as plural (the data are...).", answer: true },
          { text: "Distance or time (e.g. '10 kilometres') always takes a plural verb.", answer: false },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write a Paragraph Using Compound Subjects",
        instruction: "Write a paragraph (5–6 sentences) using at least three compound subjects (joined by 'and' or 'or'). Ensure each compound subject has the correct verb agreement.",
        prompts: [{ text: "My paragraph:", type: "box", lines: 8 }],
      },
      {
        type: "multiple-choice" as const,
        title: "Tricky Agreement: Amounts and Quantities",
        instruction: "Choose the correct verb for sentences involving amounts, time and distance.",
        parentTip: "Amounts, distances and time periods used as a single concept take singular verbs.",
        questions: [
          { prompt: "Twenty dollars ___ not much for a book.", options: ["are", "is"], answer: "is" },
          { prompt: "Three hours ___ a long time to wait.", options: ["are", "is"], answer: "is" },
          { prompt: "Ten kilometres ___ too far to walk in this heat.", options: ["are", "is"], answer: "is" },
          { prompt: "Half of the apples ___ rotten.", options: ["are", "is"], answer: "are" },
        ],
      },
      {
        type: "fill-in-blank" as const,
        title: "Progressive (Continuous) Tense Agreement",
        instruction: "Fill in the correct progressive tense form (am/is/are + -ing).",
        sentences: [
          { text: "She ___ studying for her test.", blanks: ["is studying"] },
          { text: "They ___ building a new library in town.", blanks: ["are building"] },
          { text: "I ___ learning to play the guitar.", blanks: ["am learning"] },
          { text: "He ___ not listening to the instructions.", blanks: ["is not listening"] },
          { text: "We ___ making a film for the school project.", blanks: ["are making"] },
        ],
      },
      {
        type: "open-response" as const,
        title: "Error Hunt: A Student's Draft",
        instruction: "Read this student's draft. Find and list all pronoun–verb agreement errors, then rewrite the corrected version.",
        prompts: [
          {
            text: "DRAFT:\nMe and my sister loves going to the markets on weekends. She always wants to look at the craft stalls but I prefers the food stalls. We was there last Sunday and they was packed with people. A woman who were selling handmade jewellery shown us her work. She have been making jewellery for twenty years and each piece are unique.\n\nErrors found:",
            type: "box",
            lines: 6,
          },
          { text: "Corrected draft:", type: "box", lines: 8 },
        ],
      },
      {
        type: "sorting" as const,
        title: "Sort by Subject Type",
        instruction: "Sort each subject into its type — singular pronoun, plural pronoun, collective noun, or compound subject.",
        columns: ["Singular pronoun", "Plural pronoun", "Collective noun", "Compound subject"],
        items: [
          { label: "she" },
          { label: "the committee" },
          { label: "they" },
      ...
      {
        type: "circle-correct" as const,
        title: "Relative Clauses: Agreement",
        instruction: "Circle the correct verb in the relative clause.",
        parentTip: "The relative pronoun (who, which, that) takes a verb that agrees with its antecedent — the noun it refers back to.",
        questions: [
          { prompt: "She is one of those students who always ___ their homework.", options: ["do", "does"] },
          { prompt: "He is the only student who ___ finished early.", options: ["has", "have"] },
          { prompt: "These are the books that ___ on the shelf.", options: ["is", "are"] },
          { prompt: "She is the teacher who ___ made the biggest difference.", options: ["has", "have"] },
          { prompt: "They are the ones who ___ always on time.", options: ["is", "are"] },
        ],
      },
      {
        type: "fill-in-blank" as const,
        title: "Modal Verbs and Agreement",
        instruction: "Modal verbs (can, will, should, must, may) do not change form with pronouns. Fill in the complete verb phrase.",
        sentences: [
          { text: "She ___ [can + go] to the party.", blanks: ["can go"] },
          { text: "They ___ [must + arrive] by 9 a.m.", blanks: ["must arrive"] },
          { text: "He ___ [should + read] the instructions.", blanks: ["should read"] },
          { text: "We ___ [may + be] late.", blanks: ["may be"] },
          { text: "It ___ [will + take] some time.", blanks: ["will take"] },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write Instructions Using Multiple Pronouns",
        instruction: "Write a set of instructions for a younger sibling explaining how to make their bed in the morning. Use at least three different pronouns (I, you, they, she, he) and ensure all verbs agree. Aim for 6–8 steps.",
        prompts: [{ text: "My instructions:", type: "box", lines: 10 }],
      },
      {
        type: "multiple-choice" as const,
        title: "Agreement in Passive Voice",
        instruction: "Choose the correctly formed passive voice sentence.",
        parentTip: "In passive voice, the verb 'be' must agree with the subject (who or what is receiving the action).",
        questions: [
          { prompt: "Choose the correct passive sentence:", options: ["The books was donated by local families.", "The books were donated by local families.", "The books is donated by local families."], answer: "The books were donated by local families." },
          { prompt: "Choose the correct passive sentence:", options: ["The letter were written by the principal.", "The letter was written by the principal.", "The letter been written by the principal."], answer: "The letter was written by the principal." },
        ],
      },
      {
        type: "true-false" as const,
        title: "Pronouns and Agreement: Extended Review",
        instruction: "Read each statement and decide true or false.",
        statements: [
          { text: "Modal verbs (can, will, must, may) never change form to agree with the pronoun subject.", answer: true },
          { text: "In a passive sentence, the verb must agree with the grammatical subject.", answer: true },
          { text: "Compound subjects joined by 'and' always take plural verbs.", answer: true },
          { text: "Progressive tenses (is/are/am + -ing) follow the same agreement rules as simple tenses.", answer: true },
          { text: "Relative clauses are exempt from subject–verb agreement rules.", answer: false },
        ],
      },
      {
        type: "open-response" as const,
        title: "Analyse Agreement in a Published Text",
        instruction: "Choose a paragraph from any published non-fiction book. Copy it out. Underline every subject–verb pair. Write a brief analysis confirming that all agreement is correct, or identifying any unusual cases.",
        prompts: [
          { text: "Source and paragraph:", type: "box", lines: 6 },
          { text: "My analysis:", type: "box", lines: 6 },
        ],
      },
      {
        type: "fill-in-blank" as const,
        title: "Pronoun–Verb Agreement: Across All Tenses Review",
        instruction: "Fill in the correct verb form for each tense and pronoun combination.",
        sentences: [
          { text: "[Simple present, she] She ___ [write] in her journal every morning.", blanks: ["writes"] },
          { text: "[Simple past, they] They ___ [be] surprised by the result.", blanks: ["were"] },
          { text: "[Present perfect, he] He ___ [finish] the marathon.", blanks: ["has finished"] },
          { text: "[Present progressive, we] We ___ [prepare] for the concert.", blanks: ["are preparing"] },
          { text: "[Future, she] She ___ [leave] for Sydney next month.", blanks: ["will leave"] },
          { text: "[Past perfect, I] I ___ [not see] that film before.", blanks: ["had not seen"] },
        ],
      },
      {
        type: "sorting" as const,
        title: "Sort Errors by Type",
        instruction: "Sort each incorrect sentence by the type of agreement error it contains.",
        parentTip: "Categorising errors helps develop diagnostic grammar skills — a key editing tool.",
        columns: ["Wrong form of 'be'", "Wrong form of 'have'", "Wrong -s ending (present tense)"],
        items: [
          { label: "She run every morning." },
          { label: "They was at the park." },
          { label: "He have a new bike." },
          { label: "We am ready." },
          { label: "She have finished." },
          { label: "It go very fast." },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write a Grammar Explanation: Pronoun–Verb Agreement",
        instruction: "Write a clear, complete explanation of pronoun–verb agreement suitable for a grammar guide aimed at Year 4 students. Include: the basic rule, a reference chart (pronouns with their verb forms), three common errors and corrections, and one advanced rule. Aim for 10–12 sentences.",
        prompts: [{ text: "My grammar guide entry:", type: "box", lines: 14 }],
      },
      {
        type: "multiple-choice" as const,
        title: "Agreement: A Final Diagnostic",
        instruction: "This final diagnostic covers everything from basic to advanced agreement. Choose the correct option.",
        questions: [
          { prompt: "She ___ one of those people who never gives up.", options: ["is", "are", "were"], answer: "is" },
          { prompt: "The data ___ confirming our hypothesis.", options: ["is", "are", "were — both 'is' and 'are' are acceptable in formal writing"], answer: "were — both 'is' and 'are' are acceptable in formal writing" },
          { prompt: "Neither the manager nor the staff ___ aware of the problem.", options: ["was", "were", "is"], answer: "were" },
          { prompt: "Each of the students ___ a certificate at the ceremony.", options: ["receive", "receives", "receiving"], answer: "receives" },
        ],
      },
      {
        type: "circle-correct" as const,
        title: "Final Agreement Round",
        instruction: "Circle the correct verb in each sentence.",
        questions: [
          { prompt: "The committee ___ made its decision.", options: ["have", "has"] },
          { prompt: "None of the windows ___ broken.", options: ["was", "were"] },
          { prompt: "Fifty kilometres ___ a long distance to cycle.", options: ["are", "is"] },
          { prompt: "She is one of the students who ___ always on time.", options: ["is", "are"] },
          { prompt: "The news ___ shocking.", options: ["were", "was"] },
          { prompt: "Either the teacher or the students ___ mistaken.", options: ["is", "are"] },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write Your Best Paragraph — Perfect Agreement",
        instruction: "Write the best, most carefully crafted paragraph you can manage. It can be on any topic. Use at least six different pronouns and ensure every pronoun–verb pair is correct across multiple tenses. Proofread using a pronoun sweep before finishing.",
        prompts: [{ text: "My paragraph:", type: "box", lines: 12 }],
      },
      {
        type: "home-activity" as const,
        title: "Pronoun–Verb Agreement: Mastery Project",
        instruction: "Create a comprehensive reference resource on pronoun–verb agreement that you could keep and use in future writing.",
        parentTip: "A self-created reference resource is more memorable than any bought worksheet or textbook. This project consolidates everything.",
        suggestions: [
          "Create an anchor chart with all six pronouns and their correct present, past and perfect tense verb forms.",
          "Write a one-page mini guide: 'Pronoun–Verb Agreement — Everything You Need to Know' with examples.",
          "Compile a list of the ten trickiest agreement scenarios you encountered in this worksheet, with the correct forms.",
          "Teach a ten-minute 'grammar lesson' to a family member using examples you created yourself.",
          "Write a story of at least 15 sentences using all six pronouns and three different tenses — then proofread it thoroughly.",
        ],
      },
      {
        type: "spark" as const,
        title: "Spark: The Agreement Challenge",
        content: "Set yourself the ultimate agreement challenge: write a passage of exactly 20 sentences. Every sentence must use a different subject (different pronoun, collective noun, or compound subject). Every verb must correctly agree with its subject. Read it aloud at the end — if every sentence sounds right, you have mastered pronoun–verb agreement!",
      },
      {
        type: "fill-in-blank" as const,
        title: "Perfect Tense with All Pronouns",
        instruction: "Fill in the correct perfect tense verb (has/have + past participle) for each pronoun.",
        sentences: [
          { text: "I ___ [finish] my homework.", blanks: ["have finished"] },
          { text: "She ___ [eat] already.", blanks: ["has eaten"] },
          { text: "They ___ [arrive] late.", blanks: ["have arrived"] },
          { text: "He ___ [write] three chapters.", blanks: ["has written"] },
          { text: "We ___ [visit] that museum twice.", blanks: ["have visited"] },
          { text: "It ___ [rain] for a week.", blanks: ["has rained"] },
        ],
      },
      {
        type: "circle-correct" as const,
        title: "Subjunctive Mood — Introduction",
        instruction: "In formal writing, the subjunctive uses 'were' with all pronouns (not was). Circle the correct formal option.",
        parentTip: "The subjunctive is used in hypothetical or formal contexts — 'If I were you...' is correct formal English even though 'I was' is the usual form.",
        questions: [
          { prompt: "If I ___ taller, I would play basketball.", options: ["was", "were"] },
          { prompt: "If she ___ the queen, she would change many things.", options: ["was", "were"] },
          { prompt: "I wish he ___ here to see this.", options: ["was", "were"] },
          { prompt: "If they ___ ready, we could leave.", options: ["was", "were"] },
        ],
      },
      {
        type: "true-false" as const,
        title: "Pronoun Agreement: All Tenses",
        instruction: "Read each sentence. Decide if the pronoun–verb agreement is correct for the stated tense.",
        statements: [
          { text: "[Present perfect] 'She have finished the test.' — Correct.", answer: false },
          { text: "[Simple past] 'They were at the cinema.' — Correct.", answer: true },
          { text: "[Present progressive] 'He are running.' — Correct.", answer: false },
          { text: "[Future] 'We will need more supplies.' — Correct.", answer: true },
          { text: "[Past perfect] 'She had already left when we arrived.' — Correct.", answer: true },
        ],
      },
      {
        type: "sorting" as const,
        title: "Sort: Verb Form to Tense",
        instruction: "Sort each verb phrase into the correct tense column.",
        columns: ["Simple present", "Simple past", "Present perfect", "Future"],
        items: [
          { label: "she runs" },
          { label: "they had gone" },
          { label: "he will arrive" },
          { label: "we have been" },
          { label: "I am going" },
          { label: "she was tired" },
          { label: "they have finished" },
          { label: "it will be fine" },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write a Speech Using All Pronouns",
        instruction: "Write a short motivational speech (8–10 sentences) to your class. Use every subject pronoun (I, you, he, she, we, they, it) at least once. Every verb must agree correctly with its pronoun.",
        parentTip: "Writing a speech is an excellent context for formal agreement practice — it also connects to oral language skills.",
        prompts: [{ text: "My speech:", type: "box", lines: 12 }],
      },
      {
        type: "multiple-choice" as const,
        title: "Agreement in Conditional Sentences",
        instruction: "Choose the correctly formed conditional sentence.",
        questions: [
          { prompt: "Which is correct?", options: ["If she runs fast, she will win.", "If she run fast, she will win.", "If she runs fast, she will wins."], answer: "If she runs fast, she will win." },
          { prompt: "Which is correct?", options: ["If they was ready, we could go.", "If they were ready, we could go.", "If they are ready, we can went."], answer: "If they were ready, we could go." },
          { prompt: "Which is correct?", options: ["Unless he studies, he will fail.", "Unless he study, he will fail.", "Unless he studies, he will failed."], answer: "Unless he studies, he will fail." },
        ],
      },
      {
        type: "open-response" as const,
        title: "Compare Standard and Non-standard Agreement",
        instruction: "Write a paragraph explaining the difference between standard and non-standard pronoun–verb agreement. Use three specific examples to illustrate your explanation. Discuss when each is appropriate.",
        prompts: [{ text: "My explanation:", type: "box", lines: 10 }],
      },
      {
        type: "fill-in-blank" as const,
        title: "Agreement Across Clauses",
        instruction: "Fill in the correct verb form for the underlined pronoun in each sentence.",
        sentences: [
          { text: "Although we ___ [be – past] tired, we completed the course.", blanks: ["were"] },
          { text: "She smiled because he ___ [bring – past perfect] her flowers.", blanks: ["had brought"] },
          { text: "After they ___ [finish – past perfect] lunch, they went swimming.", blanks: ["had finished"] },
          { text: "Since it ___ [be – present] cold, we lit the fire.", blanks: ["is"] },
        ],
      },
      {
        type: "open-response" as const,
        title: "Proofread and Edit: Final Practice",
        instruction: "Below is a draft paragraph containing several pronoun–verb agreement errors. Rewrite it with all errors corrected. Then count and list every error you fixed.",
        prompts: [
          {
            text: "DRAFT:\nShe are my closest friend and we has known each other since kindergarten. Every weekend we goes on an adventure somewhere in our neighbourhood. Last Saturday she suggest we climb the big fig tree in the park. It were windy but we was both brave enough to climb to the top. When we looked out, we could see our whole street stretching away like a map below us. They — the people below — didn't even noticed us.\n\nCorrected paragraph:",
            type: "box",
            lines: 10,
          },
          { text: "Errors I fixed (list each one):", type: "box", lines: 6 },
        ],
      },
      {
        type: "circle-correct" as const,
        title: "Final Agreement Check",
        instruction: "Circle the correct verb in each sentence to show mastery of pronoun–verb agreement.",
        questions: [
          { prompt: "She ___ the competition three years in a row.", options: ["has won", "have won"] },
          { prompt: "They ___ not yet decided on a name.", options: ["has", "have"] },
          { prompt: "Everyone in the class ___ a part to play.", options: ["has", "have"] },
          { prompt: "Neither he nor she ___ willing to apologise.", options: ["was", "were"] },
          { prompt: "The team ___ arrived at the venue.", options: ["has", "have"] },
          { prompt: "It ___ been a very long year.", options: ["have", "has"] },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write a Diary Entry Using Correct Agreement",
        instruction: "Write a diary entry of 8–10 sentences recounting what happened in your day. Use at least five different pronouns and at least two different tenses. Proofread your entry before finishing.",
        prompts: [{ text: "My diary entry:", type: "box", lines: 12 }],
      },
      {
        type: "multiple-choice" as const,
        title: "Pronoun–Verb Agreement: Extended Final Review",
        instruction: "This extended review tests all aspects of pronoun–verb agreement covered in this worksheet.",
        questions: [
          { prompt: "'It is I who ___ responsible.' — which verb is correct?", options: ["am", "is", "are"], answer: "am" },
          { prompt: "'None of the water ___ drinkable.' — which verb?", options: ["are", "is", "were"], answer: "is" },
          { prompt: "'The committee ___ meeting next Thursday.' — which verb?", options: ["are", "is", "were"], answer: "is" },
        ],
      },
      {
        type: "home-activity" as const,
        title: "Grammar Mastery: Final Home Activity",
        instruction: "Complete a full grammar mastery project on pronoun–verb agreement.",
        parentTip: "This final home activity brings together all the skills developed throughout the unit. Celebrate the achievement.",
        suggestions: [
          "Write a 20-sentence story using a different pronoun–verb combination in every sentence.",
          "Create a 'Grammar Errors' scrapbook: collect real examples of agreement errors (from newspapers, social media, signs) and correct them.",
          "Write a letter to a fictional publisher pitching a grammar guide for Year 4 students — include the three most important rules about pronoun–verb agreement.",
          "Teach the rule to a grandparent or older relative — explaining in your own words is the ultimate test of understanding.",
        ],
      },
      {
        type: "open-response" as const,
        title: "Pronoun–Verb Agreement: My Biggest Breakthrough",
        instruction: "Write a short reflection (4–5 sentences) on the most important thing you have learned about pronoun–verb agreement in this unit. What was the hardest concept? What are you most confident about now?",
        prompts: [{ text: "My reflection:", type: "box", lines: 8 }],
      },
      {
        type: "true-false" as const,
        title: "Pronoun–Verb Agreement: Absolute Final Check",
        instruction: "A final set of statements to confirm mastery.",
        parentTip: "Review any statements your child gets wrong together — use them to identify any concepts that need further consolidation.",
        statements: [
          { text: "In Standard Australian English, 'they was' is always an error in formal writing.", answer: true },
          { text: "Modal verbs (can, will, may, should, must) change form to agree with the pronoun.", answer: false },
          { text: "Agreement rules apply equally in simple sentences and in complex sentences with subordinate clauses.", answer: true },
          { text: "In formal writing, 'everyone' always takes a plural verb.", answer: false },
          { text: "Knowing pronoun–verb agreement rules helps you proofread your own writing more effectively.", answer: true },
        ],
      },
    ],
  },
  {
    ...
    activities: [
      // ── FOUNDATIONAL (1–20) ──────────────────────────────────────────────
      {
        ...
        instruction: "Draw a line to match each text feature with what it does.",
      ...
      {
        type: "sorting" as const,
        title: "Sort: Navigation or Understanding?",
        instruction: "Sort each text feature — does it help the reader NAVIGATE the text or UNDERSTAND the content?",
        parentTip: "Navigation features help you find information; explanatory features help you understand it.",
      ...
      {
        type: "true-false" as const,
        title: "Text Features: True or False?",
        instruction: "Read each statement and decide if it is true or false.",
        parentTip: "Read each statement aloud together — discuss the answer before your child circles it.",
        statements: [
          { text: "A heading tells you the main topic of a section.", answer: true },
          { text: "A caption explains what a photograph or illustration shows.", answer: true },
          { text: "A table of contents appears at the end of a non-fiction book.", answer: false },
          { text: "Bold text is used to highlight important or technical words.", answer: true },
          { text: "A diagram is always better than written text for explaining information.", answer: false },
          { text: "An index helps you find where a specific topic is mentioned in a book.", answer: true },
        ],
      },
      {
        type: "circle-correct" as const,
        title: "Name the Text Feature",
        instruction: "Read each description and circle the correct text feature name.",
        questions: [
          { prompt: "A list of key words and their definitions, usually at the back of a book.", options: ["Index", "Glossary", "Caption"] },
          { prompt: "A visual representation of information using images and labels.", options: ["Heading", "Caption", "Diagram"] },
          { prompt: "The words printed in heavier, darker type to draw attention.", options: ["Subheading", "Bold text", "Italics"] },
          { prompt: "A smaller title within a section that introduces a new sub-topic.", options: ["Subheading", "Caption", "Heading"] },
          { prompt: "A list at the back of a book that tells you what page a topic appears on.", options: ["Glossary", "Table of contents", "Index"] },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Which Text Feature Would You Use?",
        instruction: "Choose the best text feature for each situation.",
        questions: [
          { prompt: "You want to explain the parts of a flower using pictures and labels.", options: ["Heading", "Diagram", "Caption"], answer: "Diagram" },
          { prompt: "You want to quickly find all the pages where 'photosynthesis' is mentioned.", options: ["Table of contents", "Index", "Glossary"], answer: "Index" },
          { prompt: "You want readers to understand what a technical word means.", options: ["Heading", "Caption", "Glossary"], answer: "Glossary" },
          { prompt: "You want to introduce the main section about volcanoes.", options: ["Caption", "Heading", "Index"], answer: "Heading" },
        ],
      },
      {
        type: "open-response" as const,
        title: "Identify Text Features in a Passage",
        instruction: "Read the model non-fiction passage. Identify the text features present and explain what each one tells the reader.",
        parentTip: "Walk through the first example together. Point to the text features literally in the passage.",
        prompts: [
          {
      ...
      },
      {
        ...
        instruction: "Fill in the blank to complete each definition of a text feature.",
        sentences: [
          { text: "A ___ is a title that introduces the main topic of a whole section.", blanks: ["heading"] },
          { text: "A ___ is a shorter title that introduces a sub-topic within a section.", blanks: ["subheading"] },
          { text: "A ___ explains what a photo or illustration is showing.", blanks: ["caption"] },
          { text: "A ___ shows information visually, often with labels pointing to parts.", blanks: ["diagram"] },
          { text: "A ___ is an alphabetical list of topics and the page numbers where they appear.", blanks: ["index"] },
        ],
      },
      {
        type: "sorting" as const,
        title: "Sort Text Features: Front, Middle or Back of Book?",
        instruction: "Sort each text feature into where it is typically found in a non-fiction book.",
        parentTip: "Flip through a non-fiction book together to verify where each feature appears.",
        columns: ["Front of book", "Throughout the book", "Back of book"],
        items: [
          { label: "Table of contents" },
          { label: "Headings" },
          { label: "Index" },
      ...
      {
        type: "circle-correct" as const,
        title: "Text Feature Safari — What Is It?",
        instruction: "Read each description of something found in a non-fiction book and circle the correct text feature name.",
        questions: [
          { prompt: "'The Great Barrier Reef' — printed in large, dark letters at the top of a page.", options: ["Caption", "Heading", "Subheading"] },
          { prompt: "A small piece of text below a photograph of a coral reef that reads: 'A clownfish shelters among sea anemone tentacles.'", options: ["Heading", "Caption", "Bold text"] },
          { prompt: "An alphabetical list at the back of the book listing topics with page numbers.", options: ["Glossary", "Contents", "Index"] },
          { prompt: "A picture of a coral reef with arrows pointing to labelled parts: polyp, reef crest, lagoon.", options: ["Diagram", "Caption", "Chart"] },
          { prompt: "'Types of Coral' — a smaller title within the Great Barrier Reef section.", options: ["Heading", "Subheading", "Caption"] },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Why Do Authors Use Text Features?",
        instruction: "Choose the best reason an author would use each text feature.",
        questions: [
          { prompt: "Why would an author use bold text for a word?", options: ["To make the page look decorative", "To signal that the word is important or technical", "To show the word is wrong"], answer: "To signal that the word is important or technical" },
          { prompt: "Why do non-fiction books have a table of contents?", options: ["To fill the first pages", "To help readers find specific topics quickly", "To list the author's favourite topics"], answer: "To help readers find specific topics quickly" },
          { prompt: "Why do authors include diagrams?", options: ["To replace text entirely", "To show visually what is hard to explain in words alone", "To make books more expensive"], answer: "To show visually what is hard to explain in words alone" },
        ],
      },
      {
        type: "open-response" as const,
        title: "Spot Text Features in a Real Book",
        instruction: "Pick up a non-fiction book. Find and record five different text features. For each one, write its name and explain its purpose.",
        parentTip: "Have a non-fiction book ready — a reference book, an encyclopedia, a school textbook or a library book all work well.",
        prompts: [
          { text: "1. Feature name:              Purpose:", type: "lines", lines: 2 },
          { text: "2. Feature name:              Purpose:", type: "lines", lines: 2 },
          { text: "3. Feature name:              Purpose:", type: "lines", lines: 2 },
          { text: "4. Feature name:              Purpose:", type: "lines", lines: 2 },
          { text: "5. Feature name:              Purpose:", type: "lines", lines: 2 },
        ],
      },
      {
        type: "matching" as const,
        title: "Match Example to Text Feature",
        instruction: "Match each example to the text feature it is an example of.",
        left: [
      ...
      {
        type: "fill-in-blank" as const,
        title: "Using Text Features as a Reader",
        instruction: "Fill in the blank to complete each statement about how readers use text features.",
        parentTip: "Discuss each answer together — share how YOU use text features when reading.",
        sentences: [
          { text: "If I want to find a specific topic quickly, I look in the ___ at the back.", blanks: ["index"] },
          { text: "If I want an overview of all the topics in a book, I look at the ___ at the front.", blanks: ["table of contents"] },
          { text: "If I don't understand a technical word, I look it up in the ___ .", blanks: ["glossary"] },
          { text: "If I want to understand how something looks or works, I study the ___ .", blanks: ["diagram"] },
          { text: "If I want to know what a photo is showing, I read the ___ below it.", blanks: ["caption"] },
        ],
      },
      {
        type: "true-false" as const,
        title: "Text Features: Deeper Understanding",
        instruction: "Read each statement and decide if it is true or false.",
        statements: [
          { text: "An index and a table of contents serve exactly the same purpose.", answer: false },
          { text: "A glossary gives the meaning of technical words used in the text.", answer: true },
          { text: "Non-fiction books always use more text features than fiction books.", answer: true },
          { text: "Captions are optional — they add no useful information.", answer: false },
          { text: "A diagram can sometimes explain information more efficiently than a full paragraph.", answer: true },
        ],
      },
      {
        type: "tip" as const,
        title: "Tip: Using Text Features to Preview a Text",
        content: "Before you read a non-fiction text, preview it using its text features: read the heading and subheadings to understand the structure, look at diagrams and captions, scan any bold words. This 'text feature preview' activates prior knowledge and helps you understand the body text much more easily when you read it properly.",
      },
      {
        type: "open-response" as const,
        title: "Text Feature Preview",
        instruction: "Using a non-fiction book or article, do a text feature preview before reading. Record what you noticed and what you predict the text will be about.",
        prompts: [
          { text: "Title:", type: "lines", lines: 1 },
          { text: "Headings and subheadings I can see:", type: "lines", lines: 3 },
          { text: "Diagrams or images I noticed:", type: "lines", lines: 2 },
          { text: "Bold words I spotted:", type: "lines", lines: 2 },
          { text: "My prediction about what the text covers:", type: "lines", lines: 2 },
        ],
      },
      {
        type: "sorting" as const,
        title: "Sort: Which Type of Text Would Use This Feature?",
        instruction: "Sort each text feature into the type of non-fiction text most likely to use it.",
        columns: ["Reference book", "Newspaper/magazine article", "Textbook"],
        items: [
          { label: "Extensive index" },
          { label: "Pull quote" },
          { label: "Chapter-by-chapter table of contents" },
          { label: "Infographic" },
          { label: "Glossary" },
          { label: "Sidebar box" },
          { label: "Numbered steps" },
          { label: "Byline (author's name)" },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Which Feature Helps Most?",
        instruction: "Choose the text feature that would help most in each situation.",
        parentTip: "Discuss the reasoning together — there is not always one 'right' answer, but there is usually a 'best' answer.",
        questions: [
          { prompt: "You are researching koalas. You need to find the exact pages where koalas are mentioned.", options: ["Table of contents", "Index", "Glossary"], answer: "Index" },
          { prompt: "You want to understand the difference between a food web and a food chain.", options: ["Diagram", "Caption", "Heading"], answer: "Diagram" },
          { prompt: "You want to know what 'nocturnal' means without leaving the page.", options: ["Index", "Heading", "Glossary"], answer: "Glossary" },
        ],
      },
      {
        type: "home-activity" as const,
        title: "Text Feature Spotter — Week 1",
        instruction: "Go on a text feature safari in real non-fiction materials.",
        parentTip: "Non-fiction reading is a skill — explicitly noticing text features builds the habit of purposeful reading.",
        suggestions: [
      ...
      {
        type: "spark" as const,
        title: "Spark: Become a Text Feature Detective",
        content: "Take any non-fiction book, magazine or encyclopedia. Open to a random page and count every text feature you can find. Challenge: can you find at least six different types of text features on a single page or double-page spread? Which page has the most?",
      },
      // ── DEVELOPING (21–50) ──────────────────────────────────────────────
      {
        type: "open-response" as const,
        title: "Design a Non-fiction Page",
        instruction: "Plan one page of a non-fiction book on a topic you choose. Describe where you would place each text feature.",
        parentTip: "Talk through the page layout together before your child writes — think like a book designer.",
        prompts: [
          { text: "My topic:", type: "lines", lines: 1 },
          {
      ...
      {
        type: "fill-in-blank" as const,
        title: "Writing Effective Headings",
        instruction: "Good headings are clear, specific and tell the reader exactly what the section covers. Fill in a better heading for each weak one.",
        parentTip: "A good heading is specific: 'How Kangaroos Carry Their Young' is better than 'Baby Animals'.",
        sentences: [
          { text: "Weak heading: 'Animals' → Stronger heading: ___ .", blanks: ["How Marsupials Raise Their Young"] },
          { text: "Weak heading: 'Water' → Stronger heading: ___ .", blanks: ["The Water Cycle: From Rain to River"] },
          { text: "Weak heading: 'Space' → Stronger heading: ___ .", blanks: ["Inside the Solar System: Planets and Their Orbits"] },
          { text: "Weak heading: 'Food' → Stronger heading: ___ .", blanks: ["What Do Rainforest Animals Eat?"] },
        ],
      },
      {
        type: "circle-correct" as const,
        title: "Strong or Weak Caption?",
        instruction: "Circle the stronger, more informative caption for each image.",
        parentTip: "A strong caption tells the reader something they could not work out just from looking at the image.",
        questions: [
          {
            prompt: "A photo of a spider web with dew drops.",
            options: [
              "A spider web.",
          ...
          {
            prompt: "A photo of children in a classroom.",
            options: [
          ...
          {
            prompt: "A diagram of the sun's layers.",
            options: [
              "The sun.",
      ...
      {
        type: "open-response" as const,
        title: "Write Captions for These Images",
        instruction: "Write a strong, informative caption for each described image. A good caption: names what is shown, adds information the image alone cannot give, is written in present tense, and is one complete sentence.",
        prompts: [
          { text: "Image: A photograph of a blue-tongue lizard on a rock.\nMy caption:", type: "lines", lines: 2 },
          { text: "Image: A diagram showing the layers of the atmosphere from ground level to space.\nMy caption:", type: "lines", lines: 2 },
          { text: "Image: A photograph of Aboriginal rock art in the Kimberley region.\nMy caption:", type: "lines", lines: 2 },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Heading Hierarchy: Main Heading or Subheading?",
        instruction: "For each pair, decide which should be the main heading and which the subheading.",
        questions: [
          {
            prompt: "Pair: 'Australian Spiders' and 'The Funnel-web Spider: Australia's Most Venomous'",
            options: ["'Australian Spiders' is main; 'The Funnel-web Spider' is sub", "'The Funnel-web Spider' is main; 'Australian Spiders' is sub"],
            answer: "'Australian Spiders' is main; 'The Funnel-web Spider' is sub",
          },
          {
            prompt: "Pair: 'How Koalas Digest Eucalyptus' and 'Koala Biology'",
            options: ["'How Koalas Digest Eucalyptus' is main; 'Koala Biology' is sub", "'Koala Biology' is main; 'How Koalas Digest Eucalyptus' is sub"],
            answer: "'Koala Biology' is main; 'How Koalas Digest Eucalyptus' is sub",
          },
        ],
      },
      {
        type: "sorting" as const,
        title: "Organise a Table of Contents",
        instruction: "The topics below belong in a non-fiction book about Australian wildlife. Sort them into an order that would make sense for a table of contents.",
        columns: ["Chapters 1–3 (Early chapters)", "Chapters 4–6 (Middle chapters)", "Chapters 7–9 (Later chapters)"],
        items: [
          { label: "Introduction to Australian Wildlife" },
          { label: "Endangered Species and Conservation" },
          { label: "Mammals: Marsupials and Monotremes" },
          { label: "Reptiles: Snakes and Lizards" },
          { label: "Where to Go Birdwatching" },
          { label: "Marine Life: The Great Barrier Reef" },
          { label: "Birds of Australia" },
          { label: "Insects and Spiders" },
          { label: "Protecting Australia's Unique Ecosystems" },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write a Table of Contents",
        instruction: "Create a table of contents for a non-fiction book on a topic of your choice. Include at least six chapters, each with a clear, specific heading and a page number.",
        parentTip: "Encourage your child to think about the natural order of topics — general to specific, or chronological — before writing.",
        prompts: [
          { text: "My book title:", type: "lines", lines: 1 },
          {
      ...
      {
        type: "fill-in-blank" as const,
        title: "Glossary Writing",
        instruction: "Write a glossary definition for each term. A good definition: explains the meaning clearly, is written in simple language, and does not repeat the key word in the definition.",
        parentTip: "Writing glossary entries develops both subject knowledge and precise writing skills.",
        sentences: [
          { text: "habitat: The ___ where an animal or plant naturally lives and finds everything it needs to survive.", blanks: ["environment or place"] },
          { text: "predator: An animal that ___ and eats other animals for food.", blanks: ["hunts / catches"] },
          { text: "nocturnal: Describes an animal that is ___ during the night and sleeps during the day.", blanks: ["active"] },
          { text: "camouflage: The ability of an animal to ___ with its surroundings to avoid being seen.", blanks: ["blend in"] },
        ],
      },
      {
        type: "tip" as const,
        title: "Tip: Diagrams and Labelling",
        content: "A good diagram does two things: it shows what something looks like AND it labels key parts clearly. The labels should use technical vocabulary from the glossary. Arrows should point precisely to the correct part. A diagram with a good caption is one of the most efficient ways to explain complex information — think of a labelled cross-section of a volcano or the life cycle of a butterfly.",
      },
      {
        type: "open-response" as const,
        title: "Plan a Diagram",
        instruction: "Plan a diagram for one of the topics below. Describe: what the diagram would show, what it would be titled, and at least five labels you would include.",
        prompts: [
          {
            text: "Topics:\n  [ ] The water cycle\n  [ ] Parts of a flower\n  [ ] Life cycle of a frog\n  [ ] Inside a beehive\n  [ ] My own:\n\nDiagram title:\nWhat it shows:\nFive labels I would include:",
            type: "lines",
            lines: 10,
          },
        ],
      ...
      {
        type: "circle-correct" as const,
        title: "Is This an Effective Text Feature?",
        instruction: "Read each description and circle 'Effective' or 'Needs improvement'. Be ready to explain your choice.",
        parentTip: "Encourage your child to explain what would make the 'needs improvement' examples better.",
        questions: [
          {
            prompt: "Heading: 'Stuff About Volcanoes'",
            options: ["Effective — clear and specific", "Needs improvement — vague and uninformative"],
          },
          {
            prompt: "Caption: 'Mt Ruapehu (2,797m), New Zealand's most active volcano, erupts at sunset in 1996 — the last major eruption before the 2007 lahar.'",
            options: ["Effective — specific and informative", "Needs improvement — too short"],
          },
          {
            prompt: "Diagram of a plant with no labels.",
            options: ["Effective — the image speaks for itself", "Needs improvement — no labels means no information is conveyed"],
          },
          {
            prompt: "Glossary entry: 'Erosion: when things get worn away by water or wind over a long period of time.'",
            options: ["Effective — clear and accessible", "Needs improvement — too technical"],
          },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Text Features in Online Non-fiction",
        instruction: "Online non-fiction texts also use text features. Choose the digital equivalent of each print feature.",
        parentTip: "Connecting print and digital literacy is an increasingly important skill. Discuss websites you use together.",
        questions: [
          { prompt: "A clickable word in a web article that takes you to a related topic.", options: ["Heading", "Hyperlink", "Caption"], answer: "Hyperlink" },
          { prompt: "A short video within an article that shows how something works.", options: ["Diagram", "Embedded video", "Caption"], answer: "Embedded video" },
          { prompt: "A text box at the side of an article with extra information on a related topic.", options: ["Sidebar", "Index", "Table of contents"], answer: "Sidebar" },
        ],
      },
      {
        type: "open-response" as const,
        title: "Compare Print and Digital Text Features",
        instruction: "Compare a print non-fiction text with a website on the same topic. List the text features used in each, then write two sentences comparing how effectively each uses its features.",
        prompts: [
          { text: "Topic:", type: "lines", lines: 1 },
          { text: "Text features in the print text:", type: "lines", lines: 3 },
          { text: "Text features in the website:", type: "lines", lines: 3 },
          { text: "My comparison:", type: "lines", lines: 3 },
        ],
      },
      {
        type: "sorting" as const,
        title: "Sort Text Features by How They Present Information",
        instruction: "Sort each text feature by how it mainly presents information.",
        columns: ["Mainly visual", "Mainly written", "Both visual and written"],
        items: [
          { label: "Diagram with labels" },
          { label: "Glossary definition" },
          { label: "Photograph with caption" },
          { label: "Table of data" },
          { label: "Index entry" },
          { label: "Timeline with images" },
          { label: "Bold key term in body text" },
          { label: "Infographic" },
        ],
      },
      {
        type: "home-activity" as const,
        title: "Text Feature Spotter — Week 2",
        instruction: "Continue your text feature exploration in new texts this week.",
        parentTip: "This week focus on comparing texts — how do different authors and publishers use text features differently?",
        suggestions: [
          "Look at an online news article and identify at least four text features — headings, photos, captions, pull quotes.",
          "Find a non-fiction website about an Australian topic. List all the text features you can see.",
          "Compare a textbook chapter with a magazine article on the same topic — how does the audience change the text features used?",
          "Write three glossary definitions for technical words from your current science or HASS unit.",
        ],
      },
      {
        type: "spark" as const,
        title: "Spark: Design a Magazine Spread",
        content: "Design (by sketching or describing) a double-page magazine spread about your favourite topic. Include: a main heading, two subheadings, at least one diagram, two captions, a pull quote (an interesting sentence from the article displayed in large text), and one sidebar. Think carefully about where each feature will go on the page.",
      },
      {
        type: "fill-in-blank" as const,
        title: "Text Features in Instructions and Procedures",
        instruction: "Procedural texts (instructions, recipes, how-to guides) use specific text features. Fill in the correct feature.",
        parentTip: "Look at a recipe or instruction sheet together to see these features in a real context.",
        sentences: [
          { text: "Steps in a procedure are usually presented as a ___ list so the order is clear.", blanks: ["numbered"] },
          { text: "Technical equipment is shown in a ___ with labels so the reader knows what each part is.", blanks: ["diagram"] },
          { text: "Important warnings in instructions are often presented in a ___ box to stand out.", blanks: ["warning / highlighted"] },
          { text: "Ingredients in a recipe are listed under the ___ 'Ingredients'.", blanks: ["heading / subheading"] },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write a Procedure Using Correct Text Features",
        instruction: "Write a procedure explaining how to do something you know well (e.g. make a sandwich, play a game, care for an animal). Use at least four text features: title, numbered steps, bold key terms, and a diagram or illustration description.",
        prompts: [
          { text: "My topic:", type: "lines", lines: 1 },
          { text: "Materials/equipment needed:", type: "lines", lines: 3 },
          { text: "Steps:\n1.\n2.\n3.\n4.\n5.", type: "lines", lines: 8 },
          { text: "Diagram I would include (describe it):", type: "lines", lines: 2 },
        ],
      },
      {
        type: "tip" as const,
        title: "Tip: Text Features and the Reader",
        content: "Every text feature exists for the reader's benefit — to make the information clearer, easier to find, or easier to understand. When you write non-fiction, ask yourself: 'What does my reader need most here? A heading to know what this section is about? A diagram to understand how this works? A glossary entry to understand this word?' Reader-centred thinking makes non-fiction writing much more effective.",
      },
      // ── CONSOLIDATING (51–80) ──────────────────────────────────────────
      {
        type: "open-response" as const,
        title: "Analyse a Non-fiction Text",
        instruction: "Find a non-fiction text (book chapter, magazine article or website). Analyse how effectively it uses text features. Write your analysis in paragraph form, discussing at least four different text features.",
        parentTip: "Encourage your child to use evaluative language: 'This feature is effective because...' or 'This feature could be improved by...'",
        prompts: [
          { text: "Text title and source:", type: "lines", lines: 1 },
          { text: "My analysis:", type: "box", lines: 10 },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Text Features and Author's Purpose",
        instruction: "For each text feature choice, identify the author's likely purpose.",
        questions: [
          {
            prompt: "An author places a large colour photograph at the top of each chapter, with no caption. Why might this be a less effective choice?",
            options: [
              "Photographs are always ineffective.",
              "Without a caption, the reader does not know what the photograph shows or why it matters.",
              "Photographs cost too much to print.",
            ],
            answer: "Without a caption, the reader does not know what the photograph shows or why it matters.",
          },
          {
            prompt: "A science textbook uses numbered subheadings (1.1, 1.2, 1.3) throughout. What purpose does this serve?",
            options: [
              "It makes the book look more scientific.",
              "It helps students reference specific sections easily and understand the structure at a glance.",
              "It replaces the need for an index.",
            ],
            answer: "It helps students reference specific sections easily and understand the structure at a glance.",
          },
        ],
      },
      {
        type: "true-false" as const,
        title: "Text Features and Purpose: Advanced",
        instruction: "Read each statement and decide if it is true or false.",
        statements: [
          { text: "A text feature should always be used even when it adds no information.", answer: false },
          { text: "The heading hierarchy (main heading → subheading → body text) helps readers understand how topics and sub-topics relate.", answer: true },
          { text: "A well-written caption can provide information that neither the body text nor the image alone could convey.", answer: true },
          { text: "Online texts use the same set of text features as print texts, with no additions.", answer: false },
          { text: "The purpose of a glossary changes depending on whether the text is for experts or beginners.", answer: true },
        ],
      },
      {
        type: "open-response" as const,
        title: "Evaluate Text Features in a Textbook Chapter",
        instruction: "Read one chapter of a textbook (any subject). Evaluate how effectively the chapter uses text features. Include: a list of all features used, an assessment of one feature you thought worked very well and one that could be improved, and a recommendation.",
        prompts: [
          { text: "Textbook and chapter:", type: "lines", lines: 1 },
          { text: "All text features used:", type: "lines", lines: 3 },
          { text: "Feature that worked well and why:", type: "lines", lines: 3 },
          { text: "Feature that could be improved and how:", type: "lines", lines: 3 },
          { text: "My recommendation for the author:", type: "lines", lines: 2 },
        ],
      },
      {
        type: "sorting" as const,
        title: "Sort: Relevant or Irrelevant Text Feature?",
        instruction: "For a non-fiction text about the Great Barrier Reef, sort each potential text feature into 'Relevant — would help the reader' or 'Irrelevant — would not help'.",
        columns: ["Relevant — would help", "Irrelevant — would not help"],
        items: [
          { label: "A diagram showing coral reef zones and depths" },
          { label: "A decorative border around every page" },
          { label: "A glossary defining 'polyp', 'bleaching', 'symbiosis'" },
          { label: "A caption explaining a photo of a clownfish" },
          { label: "Decorative font that is difficult to read" },
          { label: "A map showing the location of the reef" },
          { label: "A table of contents" },
          { label: "A chart showing coral bleaching rates over 50 years" },
        ],
      },
      {
        type: "fill-in-blank" as const,
        title: "Text Feature Language — Writing About Features",
        instruction: "Fill in the correct analytical term to complete each sentence about text features.",
        parentTip: "Using precise language when discussing text features is an important academic literacy skill.",
        sentences: [
          { text: "The ___ (bold, italicised heading at the top) signals the main topic of this section.", blanks: ["heading"] },
          { text: "The ___ below the photograph tells the reader where and when the image was taken.", blanks: ["caption"] },
          { text: "The author uses a ___ to explain the term 'photosynthesis' for readers who may not know it.", blanks: ["glossary entry"] },
          { text: "The ___ at the front of the book allows the reader to navigate directly to any chapter.", blanks: ["table of contents"] },
          { text: "A ___ showing the life cycle of a butterfly is more effective here than written description alone.", blanks: ["diagram"] },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write a Non-fiction Report — With Full Text Features",
        instruction: "Research a topic from Australian history, science or geography. Write a one-page non-fiction report that includes: a main heading, at least two subheadings, body text, one diagram (describe it), captions for your diagram, at least two bold key terms, and a glossary of three terms at the end.",
        parentTip: "This is a significant writing task — allow time for research and planning. Celebrate the finished piece as a real piece of non-fiction writing.",
        prompts: [
          { text: "My topic:", type: "lines", lines: 1 },
          { text: "My report:", type: "box", lines: 16 },
        ],
      },
      {
        type: "circle-correct" as const,
        ...
        parentTip: "Use this as a mid-unit check — see where your child needs further consolidation.",
        questions: [
          { prompt: "The feature that helps you find a word's meaning within a text:", options: ["Index", "Glossary", "Caption"] },
          { prompt: "The feature that shows the structure of the whole book:", options: ["Table of contents", "Subheading", "Index"] },
          { prompt: "The feature that uses images and labels to explain how something works:", options: ["Caption", "Diagram", "Bold text"] },
          { prompt: "The feature that introduces a sub-topic within a larger section:", options: ["Heading", "Subheading", "Glossary"] },
          { prompt: "The feature that tells you what page a specific topic appears on:", options: ["Table of contents", "Caption", "Index"] },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Text Features for Different Audiences",
        instruction: "Choose the best text feature strategy for each intended audience.",
        questions: [
          {
            prompt: "A non-fiction book for 5-year-olds about dinosaurs:",
            options: [
              "Dense body text with no images.",
              "Large illustrations with simple captions and minimal text.",
              "A detailed index and glossary.",
            ],
            answer: "Large illustrations with simple captions and minimal text.",
          },
          {
            prompt: "A university biology textbook:",
            options: [
              "Only pictures, no text.",
              "Detailed text with labelled diagrams, numbered sections, a full index, and an extensive glossary.",
              "Bold headings only, no body text.",
            ],
            answer: "Detailed text with labelled diagrams, numbered sections, a full index, and an extensive glossary.",
          },
        ],
      },
      {
        type: "open-response" as const,
        title: "Reflect: How Text Features Help You as a Reader",
        instruction: "Write a personal reflection (5–6 sentences) on how you use text features when reading non-fiction. Give specific examples from your own reading experience.",
        parentTip: "Share your own experience as a reader — this models that text feature awareness is useful for adults too.",
        prompts: [{ text: "My reflection:", type: "box", lines: 8 }],
      },
      {
        type: "home-activity" as const,
        title: "Text Feature Creator — Extended Project",
        instruction: "Create your own illustrated non-fiction page or double-page spread on a topic of your choice, using at least five different text features.",
        parentTip: "Display the finished page. A hand-drawn non-fiction page is a meaningful artefact of learning that can be added to a portfolio.",
        suggestions: [
          "Draft your page in pencil first — plan the layout before you commit.",
          "Include: heading, subheading, body text, diagram with labels, caption and at least two bold key terms.",
          "If you have access to a printer, you could type and design it using a word processor.",
          "Add a mini-glossary of three terms at the bottom of the page.",
          "Read your finished page aloud to a family member and ask them: is everything clear? Are the features helpful?",
        ],
      },
      {
        type: "spark" as const,
        title: "Spark: Text Features Tell a Story",
        content: "Flip through any non-fiction book reading ONLY the text features — headings, captions, bold words, diagram labels. Can you understand the main ideas of the book without reading the body text? What does this tell you about the power of text features?",
      },
      // ── EXTENDING (81–100) ───────────────────────────────────────────────
      {
        type: "open-response" as const,
        title: "Critical Analysis: When Text Features Fail",
        instruction: "Analyse a non-fiction text that uses text features poorly — a confusing layout, unhelpful captions, missing glossary, or poor headings. Write a detailed critique (6–8 sentences) explaining what is wrong and how it could be improved.",
        parentTip: "Critical analysis of what does NOT work is as important as noticing what does. This is higher-order thinking.",
        prompts: [
          { text: "Text source:", type: "lines", lines: 1 },
          { text: "My critique:", type: "box", lines: 10 },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Advanced Analysis: Text Feature Choices",
        instruction: "Read each scenario and choose the most analytically sophisticated response.",
        questions: [
          {
            prompt: "Why might an author of a book for general readers choose NOT to include an index?",
            options: [
              "Authors never need indexes.",
              "If the book is a narrative non-fiction read front-to-back, like a story, an index is less necessary than it would be for a reference text.",
              "Indexes take too long to write.",
            ],
            answer: "If the book is a narrative non-fiction read front-to-back, like a story, an index is less necessary than it would be for a reference text.",
          },
          {
            prompt: "An author uses no subheadings in a chapter about climate change. Is this necessarily poor practice?",
            options: [
              "Yes — all non-fiction must have subheadings.",
              "Not necessarily — if the argument flows continuously and logically without needing to be broken up, subheadings might interrupt the reading experience.",
              "Yes — readers always need subheadings.",
            ],
            answer: "Not necessarily — if the argument flows continuously and logically without needing to be broken up, subheadings might interrupt the reading experience.",
          },
        ],
      },
      {
        type: "open-response" as const,
        title: "Design a Non-fiction Book on a Research Topic",
        instruction: "Plan a short non-fiction book (5 chapters) on a topic you have researched. For each chapter: write the chapter heading, two subheadings, describe one text feature you would include (diagram, chart, map, photo) and explain why you chose it.",
        parentTip: "This planning task builds awareness that text feature choices are strategic — they depend on the content and reader.",
        prompts: [
          { text: "My book title and topic:", type: "lines", lines: 1 },
          { text: "Chapter 1 heading:\nSubheading 1:\nSubheading 2:\nText feature and reason:", type: "lines", lines: 5 },
          { text: "Chapter 2 heading:\nSubheading 1:\nSubheading 2:\nText feature and reason:", type: "lines", lines: 5 },
          { text: "Chapter 3 heading:\nSubheading 1:\nSubheading 2:\nText feature and reason:", type: "lines", lines: 5 },
          { text: "Chapter 4 heading + Chapter 5 heading (brief notes):", type: "lines", lines: 4 },
        ],
      },
      {
        type: "true-false" as const,
        title: "Critical Thinking: Text Features",
        instruction: "These statements require careful analysis. Decide true or false.",
        parentTip: "Some of these are nuanced — encourage your child to explain the reasoning behind each answer.",
        statements: [
          { text: "A text feature should only be included if it genuinely helps the reader understand the content.", answer: true },
          { text: "More text features always means a more effective non-fiction text.", answer: false },
          { text: "An author's choice of which text features to use reflects their understanding of the audience's needs.", answer: true },
          { text: "Digital texts can include interactive text features that print texts cannot.", answer: true },
          { text: "A well-designed non-fiction text requires text features to be visually consistent throughout.", answer: true },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write an Informative Report on an Australian Topic — Fully Featured",
        instruction: "Research an Australian topic from history, science or geography. Write a two-page non-fiction report using all of the following text features: main heading, at least three subheadings, body paragraphs, one diagram description with labels, captions, bold key terms, a table of contents for your report, and a glossary of five terms.",
        parentTip: "This is the culminating writing task for this unit. Allow time for research, drafting and editing. Celebrate the finished piece.",
        prompts: [
          { text: "My topic:", type: "lines", lines: 1 },
          { text: "Table of contents:", type: "lines", lines: 5 },
          { text: "My report:", type: "box", lines: 18 },
          { text: "Glossary (5 terms):", type: "box", lines: 8 },
        ],
      },
      {
        type: "tip" as const,
        title: "Tip: Text Features and Information Literacy",
        content: "Understanding text features is not just a reading skill — it is an information literacy skill. Knowing how non-fiction texts are organised helps you find information faster, evaluate sources more critically, and communicate your own research more effectively. These skills will serve you in every subject and throughout your education.",
      },
      {
        type: "open-response" as const,
        title: "Teach It: Explain Text Features to a Younger Reader",
        instruction: "Write a guide for a Year 1 or Year 2 student explaining what text features are and how to use them. Include five features and explain each in simple language with an example. Think carefully about your audience.",
        prompts: [{ text: "My guide:", type: "box", lines: 12 }],
      },
      {
        type: "multiple-choice" as const,
        title: "Text Features: Year 4 Mastery Review",
        instruction: "Answer each question about text features in non-fiction texts.",
        questions: [
          {
            prompt: "What is the PRIMARY difference between a table of contents and an index?",
            options: [
              "A table of contents lists topics in alphabetical order; an index lists them by chapter.",
              "A table of contents shows the book's overall structure in chapter order; an index lists topics alphabetically with page references.",
              "An index is at the front; a table of contents is at the back.",
            ],
            answer: "A table of contents shows the book's overall structure in chapter order; an index lists topics alphabetically with page references.",
          },
          {
            prompt: "Which text feature choice best supports a reader who is unfamiliar with scientific vocabulary?",
            options: [
              "More subheadings",
              "A comprehensive glossary",
              "Larger font size",
            ],
            answer: "A comprehensive glossary",
          },
          {
            prompt: "A good caption for a diagram does what that a heading alone cannot?",
            options: [
              "Provides the topic of the whole section.",
              "Explains the specific information shown in the image, including details that may not be in the body text.",
              "Lists the page numbers.",
            ],
            answer: "Explains the specific information shown in the image, including details that may not be in the body text.",
          },
        ],
      },
      {
        type: "open-response" as const,
        title: "Self-Assessment: Text Features Toolkit",
        instruction: "Complete your own toolkit assessment. For each text feature, write: what it is, what it does, and one example of when you have used it or seen it used effectively.",
        prompts: [
          { text: "Heading — definition, purpose, example:", type: "lines", lines: 3 },
          { text: "Subheading — definition, purpose, example:", type: "lines", lines: 3 },
          { text: "Caption — definition, purpose, example:", type: "lines", lines: 3 },
          { text: "Diagram — definition, purpose, example:", type: "lines", lines: 3 },
          { text: "Glossary — definition, purpose, example:", type: "lines", lines: 3 },
        ],
      },
      {
        type: "home-activity" as const,
        title: "Text Feature Portfolio",
        instruction: "Compile a portfolio of text features from real texts — clippings, printouts or photographs.",
        parentTip: "A physical portfolio of collected text features makes an excellent reference resource for future writing projects.",
        suggestions: [
          "Find and cut out or print examples of five different text features from newspapers, magazines or printed web pages.",
          "For each example, write a label explaining: what the feature is, which text it comes from, and why it is effective.",
          "Write a one-page reflection on what you have learned about text features in non-fiction during this unit.",
          "Share your portfolio with a family member and explain each text feature in your own words.",
          "Choose one text feature you would like to use more often in your own writing and practise it in a piece this week.",
        ],
      },
      {
        type: "spark" as const,
        title: "Spark: The Impossible Non-fiction Text",
        content: "Imagine a non-fiction book with absolutely NO text features — no headings, no table of contents, no captions, no bold words, no index, no diagrams. Just solid paragraphs of text from beginning to end. How would this change the reading experience? Write a paragraph imagining what it would be like to use this book as a reference. What would be frustrating? What could you NOT do?",
      },
      // ── EXTENDING CONTINUED (63–100) ─────────────────────────────────────
      {
        type: "fill-in-blank" as const,
        title: "Text Features in Digital News",
        instruction: "Fill in the correct digital text feature term to match each description.",
        parentTip: "Comparing digital and print features builds media literacy alongside non-fiction literacy.",
        sentences: [
          { text: "A short, bold summary of the article's main point displayed above the headline is called a ___ .", blanks: ["standfirst / subheadline / deck"] },
          { text: "A ___ takes the reader to another page or website when clicked.", blanks: ["hyperlink"] },
          { text: "In an online article, a ___ shows which section of the website you are in (e.g. Home > Science > Oceans).", blanks: ["breadcrumb trail"] },
          { text: "An ___ at the top of an article shows a summary of the article's key points as bullet points.", blanks: ["abstract / key points box"] },
          { text: "A moving or interactive data visualisation in a digital text is called an ___ .", blanks: ["infographic / interactive graphic"] },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write a Non-fiction Introduction Using Text Features",
        instruction: "Write the introduction to a non-fiction chapter on a topic of your choice. Your introduction must: have a clear main heading, include a 'hook' first sentence, use at least one bold key term, and end with a sentence that previews the subheadings to come.",
        prompts: [
          { text: "Topic:", type: "lines", lines: 1 },
          { text: "My introduction:", type: "box", lines: 8 },
        ],
      },
      {
        type: "circle-correct" as const,
        title: "Text Features: Which Is Better?",
        instruction: "For each scenario, circle the better text feature choice.",
        questions: [
          {
            prompt: "To explain the water cycle in a junior science textbook:",
            options: [
          ...
          {
            prompt: "For a Year 4 student trying to find which page discusses coral bleaching:",
            options: [
          ...
          {
            prompt: "To highlight that 'photosynthesis' is an important term in a science text:",
            options: [
      ...
      {
        type: "true-false" as const,
        title: "Text Features: Which Claims Are True?",
        instruction: "Read each claim and decide if it is true or false.",
        statements: [
          { text: "Non-fiction texts written for expert audiences may use fewer definitions and glossary entries than those for beginners.", answer: true },
          { text: "A caption must always be placed directly below its corresponding image.", answer: false },
          { text: "A well-structured table of contents reflects the logical organisation of the whole text.", answer: true },
          { text: "Adding more images always makes a non-fiction text more effective.", answer: false },
          { text: "Different non-fiction genres (instruction manual, travel guide, encyclopedia) use different combinations of text features.", answer: true },
        ],
      },
      {
        type: "matching" as const,
        title: "Match Text Feature to Non-fiction Genre",
        instruction: "Match each text feature set to the non-fiction genre most likely to use it.",
        parentTip: "Different non-fiction genres have different conventions — this connects text features to real-world reading contexts.",
        left: [
      ...
      {
        type: "open-response" as const,
        title: "Design a Non-fiction Page for a Specific Audience",
        instruction: "Choose one topic and two different audiences. Plan two different non-fiction page designs for the same topic — one for a young child (Year 1) and one for an adult reader. Describe the text features you would use for each and explain why they differ.",
        prompts: [
          { text: "Topic:", type: "lines", lines: 1 },
          { text: "Design for Year 1 audience (describe features and layout):", type: "box", lines: 6 },
          { text: "Design for adult reader (describe features and layout):", type: "box", lines: 6 },
          { text: "Why the two designs differ:", type: "lines", lines: 3 },
        ],
      },
      {
        type: "sorting" as const,
        title: "Sort: Which Text Feature Serves This Reader?",
        instruction: "Sort each reader scenario into the text feature that would help them most.",
        columns: ["Table of contents", "Index", "Glossary", "Diagram"],
        items: [
          { label: "A reader who doesn't know what 'mitosis' means." },
          { label: "A reader who wants to know how a bicycle gear works." },
          { label: "A reader who wants to find all pages that mention 'Darwin'." },
          { label: "A reader who wants to know what chapters the book has." },
          { label: "A reader who doesn't understand 'tectonic plates'." },
          { label: "A reader who wants to jump to Chapter 5." },
          { label: "A reader who wants to see how the circulatory system connects to the lungs." },
          { label: "A reader who wants to know every chapter that covers Indigenous Australia." },
        ],
      },
      {
        type: "fill-in-blank" as const,
        title: "Analytical Sentences About Text Features",
        instruction: "Complete each analytical sentence about text features in non-fiction.",
        sentences: [
          { text: "The heading '___ The Life Cycle of a Frog ___' signals to the reader that this section will ___ .", blanks: ["explain or describe the stages of a frog's development"] },
          { text: "The author uses ___ to highlight the word 'metamorphosis', indicating that it is a ___ term the reader should learn.", blanks: ["bold text", "key / technical"] },
          { text: "The ___ below the photograph of a platypus provides additional information about the image that ___ .", blanks: ["caption", "the body text does not include"] },
          { text: "Without an ___ , a reader would need to read the entire book to find specific information about 'eucalyptus'.", blanks: ["index"] },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Text Features and Purpose: Advanced Questions",
        instruction: "Choose the most insightful answer for each question.",
        questions: [
          {
            prompt: "A non-fiction book for general readers has no index. Is this necessarily a problem?",
            options: [
              "Yes — every non-fiction book needs an index.",
              "Not necessarily — if the book is narrative non-fiction meant to be read sequentially (like a biography or popular science book), readers may not need to look up specific topics.",
              "No — indexes are only for textbooks.",
            ],
            answer: "Not necessarily — if the book is narrative non-fiction meant to be read sequentially (like a biography or popular science book), readers may not need to look up specific topics.",
          },
          {
            prompt: "A travel article uses large, vivid photographs with detailed captions. What purpose do these serve beyond decoration?",
            options: [
              "They have no informational purpose.",
              "They provide visual evidence of the places described, create emotional appeal, and supply information (through captions) that the reader can grasp quickly.",
              "They reduce the amount of text needed.",
            ],
            answer: "They provide visual evidence of the places described, create emotional appeal, and supply information (through captions) that the reader can grasp quickly.",
          },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write a Glossary for Your Research Topic",
        instruction: "Choose the research topic you have been studying this term (from any subject). Write a glossary of 8–10 key terms. Each definition should be clear, concise and written in your own words.",
        parentTip: "Writing glossary entries in their own words forces students to truly understand terminology rather than copy definitions.",
        prompts: [
          { text: "Topic:", type: "lines", lines: 1 },
          { text: "Glossary:\n1.\n2.\n3.\n4.\n5.\n6.\n7.\n8.", type: "box", lines: 12 },
        ],
      ...
      {
        type: "circle-correct" as const,
        title: "Text Feature Mastery Review",
        instruction: "Circle the best answer for each question.",
        parentTip: "Use this as a formal mastery review — your child should attempt all questions independently.",
        questions: [
          { prompt: "Which text feature would a reader use first to find out what a non-fiction book is about?", options: ["Index", "Table of contents", "Glossary"] },
          { prompt: "Which text feature explains the meaning of technical words used in the text?", options: ["Heading", "Glossary", "Caption"] },
          { prompt: "Which text feature best helps a reader understand how the parts of a machine work?", options: ["Diagram", "Index", "Heading"] },
          { prompt: "Which text feature appears below a photograph and provides additional information?", options: ["Heading", "Subheading", "Caption"] },
          { prompt: "Which feature helps readers find every page where 'climate change' is mentioned?", options: ["Table of contents", "Index", "Glossary"] },
        ],
      },
      {
        type: "open-response" as const,
        title: "Final Project: Create a Non-fiction Booklet",
        instruction: "Create a non-fiction booklet (4–5 pages) on a topic you have researched this term. Your booklet must include: a cover page with title and author, a table of contents, at least three sections each with a heading and subheadings, at least one diagram with labels, captions under all images, bold key terms in the body text, and a glossary of five terms on the final page.",
        parentTip: "This is the culminating project for the whole unit. Allow several sessions for research, drafting, illustration and editing. Display the finished booklet.",
        prompts: [
          { text: "Topic:", type: "lines", lines: 1 },
          { text: "Table of contents (planned):", type: "lines", lines: 6 },
          { text: "Draft of main content:", type: "box", lines: 16 },
          { text: "Glossary (5 terms):", type: "box", lines: 8 },
        ],
      },
      {
        type: "true-false" as const,
        title: "Text Features: Final Mastery Check",
        instruction: "Read each statement and decide true or false.",
        statements: [
          { text: "A text feature should be included only when it genuinely serves the reader's needs.", answer: true },
          { text: "More text features always result in a better non-fiction text.", answer: false },
          { text: "The choice of text features should reflect both the audience and the purpose of the text.", answer: true },
          { text: "Digital non-fiction texts can include text features that print texts cannot.", answer: true },
          { text: "An effective table of contents reveals the logical structure of the text at a glance.", answer: true },
        ],
      },
      {
        type: "open-response" as const,
        title: "Self-Assessment: My Text Feature Toolkit",
        instruction: "Complete a self-assessment of your knowledge of non-fiction text features. For each feature, write: what it is, what it does, and whether you feel confident using it in your own writing.",
        prompts: [
          { text: "Heading:", type: "lines", lines: 2 },
          { text: "Subheading:", type: "lines", lines: 2 },
          { text: "Caption:", type: "lines", lines: 2 },
          { text: "Diagram:", type: "lines", lines: 2 },
          { text: "Table of contents:", type: "lines", lines: 2 },
          { text: "Glossary:", type: "lines", lines: 2 },
          { text: "Index:", type: "lines", lines: 2 },
          { text: "Bold text:", type: "lines", lines: 2 },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Text Features: Final Quiz",
        instruction: "Choose the best answer for each final question.",
        questions: [
          {
            prompt: "What is the main purpose of a glossary in a non-fiction text?",
            options: [
              "To list all topics covered in alphabetical order with page numbers.",
              "To provide definitions of technical or key words used in the text.",
              "To give an overview of the book's chapters.",
            ],
            answer: "To provide definitions of technical or key words used in the text.",
          },
          {
            prompt: "How does a labelled diagram help a reader more than a photograph alone?",
            options: [
              "A diagram has labels that identify and name each part, making the structure explicit.",
              "A diagram is always clearer than a photograph.",
              "A diagram does not need a caption.",
            ],
            answer: "A diagram has labels that identify and name each part, making the structure explicit.",
          },
          {
            prompt: "What makes a heading 'effective' in non-fiction writing?",
            options: [
              "It is colourful and decorative.",
              "It is specific, accurate and tells the reader exactly what the section will cover.",
              "It is as short as possible.",
            ],
            answer: "It is specific, accurate and tells the reader exactly what the section will cover.",
          },
        ],
      },
      {
        type: "home-activity" as const,
        title: "Text Feature Portfolio — Final Week",
        instruction: "Complete your text feature portfolio with examples from three different types of non-fiction texts.",
        parentTip: "A completed portfolio is a genuine achievement — it demonstrates media literacy and non-fiction reading skills that will serve your child across all subjects.",
        suggestions: [
          "Find examples of five different text features from a newspaper, a textbook, and a website. Mount and label them.",
          "Write a paragraph for each example explaining: what the feature is, which text it comes from, and what it achieves.",
          "Write a final reflection: how has your understanding of text features changed since starting this unit?",
          "Create a 'Text Features Guide' — a one-page reference card you could use when writing non-fiction in any subject.",
          "Share your portfolio with a family member. Teach them one text feature they might not have known about.",
        ],
      },
      {
        type: "spark" as const,
        title: "Spark: Design the Perfect Non-fiction Page",
        content: "You are now a non-fiction book designer. Design (by sketching or writing) what you believe is the perfect single page of non-fiction — one that uses text features in the most effective possible way. Include every feature you would want, placed exactly where it will help the reader most. Label each feature and explain your design decisions.",
      },
      {
        type: "fill-in-blank" as const,
        title: "Text Feature Terms: Quick Recall",
        instruction: "Fill in the correct text feature name for each definition.",
        sentences: [
          { text: "A ___ is an alphabetical list of key words with their meanings.", blanks: ["glossary"] },
          { text: "A ___ is a list showing page numbers for topics, placed at the back of a book.", blanks: ["index"] },
          { text: "A ___ is a visual representation of information with labels.", blanks: ["diagram"] },
          { text: "A ___ introduces a smaller sub-section within a larger section.", blanks: ["subheading"] },
          { text: "A ___ is a sentence below a photo or illustration explaining what it shows.", blanks: ["caption"] },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Text Features: Real-world Application",
        instruction: "Choose the best text feature strategy for each real-world scenario.",
        questions: [
          {
            prompt: "You are creating a school project report about climate change. You want your reader to find your sections easily.",
            options: ["Use no headings — just write in paragraphs.", "Use clear headings and a table of contents.", "Bold every second word."],
            answer: "Use clear headings and a table of contents.",
          },
          {
            prompt: "You are writing about how tornadoes form. You want to show the stages visually.",
            options: ["Write a very long paragraph.", "Create a labelled diagram showing each stage.", "Use only bold text."],
            answer: "Create a labelled diagram showing each stage.",
          },
          {
            prompt: "You use the word 'supercell' in your weather report. You want readers to understand it.",
            options: ["Don't explain it.", "Bold the word and include it in a glossary at the end.", "Use it in a heading."],
            answer: "Bold the word and include it in a glossary at the end.",
          },
        ],
      },
      {
        type: "open-response" as const,
        title: "Write and Annotate a Non-fiction Passage",
        instruction: "Write a short non-fiction passage (4–5 sentences) on a topic you know well. Then annotate it by labelling every text feature you used, writing arrows and labels in the margin.",
        prompts: [
          { text: "Topic:", type: "lines", lines: 1 },
          { text: "My passage (write and annotate):", type: "box", lines: 10 },
        ],
      },
      {
        type: "circle-correct" as const,
        title: "Effective Heading or Not?",
        instruction: "Circle 'Effective' or 'Needs work' for each heading.",
        questions: [
          { prompt: "Heading: 'How the Great Barrier Reef Is Affected by Rising Ocean Temperatures'", options: ["Effective — specific and informative", "Needs work — too vague"] },
          { prompt: "Heading: 'Animals'", options: ["Effective", "Needs work — far too broad and vague"] },
          { prompt: "Heading: 'The Role of Mangroves in Protecting Coastal Ecosystems'", options: ["Effective — specific and informative", "Needs work"] },
          { prompt: "Heading: 'Chapter 4'", options: ["Effective", "Needs work — gives no information about content"] },
        ],
      },
      {
        type: "open-response" as const,
        title: "Improve the Non-fiction Page",
        instruction: "The non-fiction page below is missing text features. List at least five text features you would add, where you would place each, and what purpose it would serve.",
        prompts: [
          {
            text: "PAGE:\nThe platypus is one of Australia's most unusual animals. It is a mammal that lays eggs. It has a duck-like bill which it uses to sense electrical signals from prey. The platypus lives in eastern Australia and Tasmania. Males have venomous spurs on their hind legs. It is an excellent swimmer and can stay underwater for up to two minutes.\n\nText features I would add and why:",
            type: "box",
            lines: 10,
          },
        ],
      ...
      {
        type: "true-false" as const,
        title: "Text Features: Critical Evaluation",
        instruction: "Read each claim and decide true or false.",
        statements: [
          { text: "A diagram is only useful if it has labels explaining each part.", answer: true },
          { text: "A table of contents and an index can both help a reader navigate a text, but in different ways.", answer: true },
          { text: "In a recipe, steps must be numbered to show that order matters.", answer: true },
          { text: "Captions should repeat exactly what is said in the body text.", answer: false },
          { text: "A glossary is most useful for readers who are new to a topic.", answer: true },
        ],
      },
      {
        type: "sorting" as const,
        title: "Sort Text Features by Audience Need",
        instruction: "Sort each text feature by which reader need it primarily addresses.",
        columns: ["Find information quickly", "Understand vocabulary", "Understand how something works visually", "Get an overview of the whole text"],
        items: [
          { label: "Index" },
          { label: "Glossary" },
          { label: "Diagram" },
          { label: "Table of contents" },
          { label: "Hyperlink (in digital text)" },
          { label: "Bold key term" },
          { label: "Labelled cross-section" },
          { label: "Chapter headings" },
        ],
      },
      {
        type: "matching" as const,
        title: "Match Text Feature to Example",
        instruction: "Match each example to the text feature type it represents.",
        parentTip: "This review activity brings together all the text features covered in this unit.",
        left: [
      ...
      {
        type: "open-response" as const,
        title: "Write a Complete Non-fiction Report With All Text Features",
        instruction: "Using your research from this unit, write a complete one-page non-fiction report. Include ALL of the following: main heading, at least two subheadings, body paragraphs, diagram description with labels, caption, bold key terms, and a three-entry glossary. Present it as neatly as possible.",
        prompts: [
          { text: "Topic:", type: "lines", lines: 1 },
          { text: "Complete report:", type: "box", lines: 18 },
          { text: "Glossary:", type: "box", lines: 5 },
        ],
      },
      {
        type: "open-response" as const,
        title: "Text Features Unit Reflection",
        instruction: "Write a final reflection on this unit. Include: three text features you now understand confidently, one challenge you faced, and one way you plan to use text features differently in your own writing from now on.",
        prompts: [{ text: "My reflection:", type: "box", lines: 10 }],
      },
      {
        type: "fill-in-blank" as const,
        title: "Text Feature Terminology: Final Recall",
        instruction: "Fill in the missing term to complete each sentence.",
        sentences: [
          { text: "A ___ is placed at the front of a book to show chapter titles and page numbers.", blanks: ["table of contents"] },
          { text: "A ___ is placed at the back of a book in alphabetical order to help locate topics by page.", blanks: ["index"] },
          { text: "A ___ explains the meaning of a key or technical word used in the text.", blanks: ["glossary entry"] },
          { text: "A ___ uses images and labels to show how something works or is structured.", blanks: ["diagram"] },
          { text: "A ___ appears below a photograph to explain what it shows.", blanks: ["caption"] },
        ],
      },
      {
        type: "circle-correct" as const,
        title: "Which Text Feature Is Most Important Here?",
        instruction: "For each situation, circle the most important text feature the author should include.",
        questions: [
          { prompt: "A student wants to find where 'erosion' is discussed in a geography textbook.", options: ["Table of contents", "Index", "Heading"] },
          { prompt: "A reader does not understand the term 'plate tectonics'.", options: ["Caption", "Glossary", "Subheading"] },
          { prompt: "An author wants to show how a volcano erupts step by step.", options: ["Bold text", "Diagram with labels", "Table of contents"] },
          { prompt: "A reader wants to know what topics are covered across the whole book.", options: ["Index", "Table of contents", "Glossary"] },
          { prompt: "A photograph shows the Bungle Bungle Range in Western Australia.", options: ["Index", "Bold text", "Caption"] },
        ],
      },
      {
        type: "multiple-choice" as const,
        title: "Text Features: Evaluating Effectiveness",
        instruction: "Choose the most insightful answer for each question.",
        questions: [
          {
            prompt: "An author writes a heading that reads: 'Section 4'. What is the problem?",
            options: ["Headings should not be numbered.", "A heading like 'Section 4' gives the reader no information about the content of that section.", "Headings must be questions."],
            answer: "A heading like 'Section 4' gives the reader no information about the content of that section.",
          },
          {
            prompt: "A textbook has beautiful photographs but no captions. What is the problem?",
            options: ["Photographs are not useful.", "Without captions, readers cannot know what the photographs show or why they are relevant.", "Photographs should be in colour."],
            answer: "Without captions, readers cannot know what the photographs show or why they are relevant.",
          },
        ],
      },
      {
        type: "open-response" as const,
        title: "Evaluate a Website for Text Features",
        instruction: "Visit a website about a topic you are curious about. Evaluate how effectively it uses text features. Write a detailed analysis of at least four text features you notice.",
        parentTip: "Applying text feature analysis to digital contexts is an essential modern literacy skill.",
        prompts: [
          { text: "Website name and topic:", type: "lines", lines: 1 },
          { text: "Text features I noticed and my evaluation of each:", type: "box", lines: 10 },
        ],
      },
      {
        type: "sorting" as const,
        title: "Final Sort: Text Feature Purposes",
        instruction: "This is your final sorting activity for the unit. Sort each text feature by its primary purpose.",
        parentTip: "Use this as a full review of all text features covered in this unit.",
        columns: ["Help navigation", "Help comprehension of content", "Highlight vocabulary"],
        items: [
          { label: "Table of contents" },
          { label: "Labelled diagram" },
          { label: "Bold key term + glossary" },
          { label: "Index" },
          { label: "Caption" },
          { label: "Subheading" },
          { label: "Glossary definition" },
      ...
      {
        type: "open-response" as const,
        title: "Write a Non-fiction Page on an Australian Topic",
        instruction: "Write a non-fiction page about an Australian animal, place or event. Include ALL of these text features: main heading, two subheadings, body text, a description of a diagram you would include (with labels), a caption, and at least three bold key terms. This is a showcase of your non-fiction writing skills.",
        prompts: [
          { text: "Topic:", type: "lines", lines: 1 },
          { text: "My non-fiction page:", type: "box", lines: 18 },
        ],
      },
      {
        type: "true-false" as const,
        title: "Non-fiction Text Features: Absolute Final Check",
        instruction: "A final set of statements to confirm your understanding of text features.",
        statements: [
          { text: "Text features are tools for the reader — their purpose is to make information accessible.", answer: true },
          { text: "A non-fiction text is always more effective with more text features.", answer: false },
          { text: "The best text feature choices depend on the audience, purpose and content of the text.", answer: true },
          { text: "A glossary at the back of a book serves the same purpose as an index.", answer: false },
          { text: "Knowing how to use text features effectively is a skill that helps in every subject, not just English.", answer: true },
        ],
      },
      {
        type: "open-response" as const,
        title: "My Non-fiction Reading Strategy",
        instruction: "Write a short guide (5–6 sentences) explaining how YOU will use text features as a reader from now on. Include specific strategies for: starting a new non-fiction text, finding a specific piece of information quickly, and understanding unfamiliar vocabulary.",
        prompts: [{ text: "My reading strategy:", type: "box", lines: 8 }],
      },
      {
        type: "matching" as const,
        title: "Final Review: Match Text Feature to Its Best Description",
        instruction: "Review all text features by matching each one to its most precise description.",
        parentTip: "If your child hesitates on any match, use it as a conversation to revisit that feature one more time.",
        left: [
          "Index",
          "Table of contents",
          "Diagram",
      ...
      {
        type: "open-response" as const,
        title: "Letter to Next Year's Students: What I Learned About Text Features",
        instruction: "Write a letter to next year's Year 4 students explaining what text features are and why they matter. Be encouraging, specific and give at least three examples. This is your final piece of writing for this unit.",
        parentTip: "Writing for an audience — even an imagined one — transforms how students approach composition. This letter is a meaningful culminating task.",
        prompts: [{ text: "Dear Year 4 students,", type: "box", lines: 14 }],
      },
      {
        type: "spark" as const,
        title: "Spark: You Are the Expert",
        content: "You have now become an expert on non-fiction text features. For one week, every time you read any non-fiction text — a textbook, a website, a magazine, a cereal box — notice the text features the author chose. Ask yourself: why did they choose this feature here? Is it working? What would you do differently? This is how professional editors and designers think.",
      },
    ],
  },
];
