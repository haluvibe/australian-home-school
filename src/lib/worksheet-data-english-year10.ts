    ...
    activities: [
      {
        ...
        prompts: [
          {
            text: "What is 'ideology' in the context of analysing texts?",
            type: "lines" as const,
            lines: 3,
          },
          {
            text: "What do we mean by 'representation' in English? How is it different from just 'describing' something?",
            type: "lines" as const,
            lines: 3,
          },
          {
            text: "What is a 'dominant reading' of a text? What might cause different readers to resist it?",
            type: "lines" as const,
            lines: 3,
          },
        ],
      ...
      },
      {
        ...
        prompts: [
          {
            text: "What assumptions does the word 'loitering' make about the youths' behaviour? What alternative word could have been used, and what effect would it have?",
            type: "lines" as const,
            lines: 4,
          },
          {
            text: "Whose perspective does this report adopt? Whose voice is absent?",
            type: "lines" as const,
            lines: 3,
          },
          {
            text: "Rewrite the extract from a different ideological position. Change at least four specific word or structural choices. Then explain what changed and why.",
            type: "box" as const,
          },
        ],
      },
      ...
      },
      {
        ...
        instruction:
          "Choose a text you have read or watched recently (a novel, film, TV series, or advertisement). Write a structured analytical response addressing all three prompts.",
        prompts: [
          {
            text: "Identify one group (people, place, or idea) that is represented in the text. Describe how they are represented, using at least two specific textual examples.",
            type: "box" as const,
          },
          {
            text: "What ideology or worldview does this representation reflect? What does the text seem to value, fear, or take for granted?",
            type: "box" as const,
          },
          {
            text: "How might a reader from a different cultural background or historical period receive this representation differently?",
            type: "box" as const,
          },
        ],
      },
